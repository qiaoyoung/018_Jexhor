...
@interface TextEmoticon : NSObject
...
@interface ContainerColorRead : NSObject
...
@interface SizeCatalog : NSObject
//: @property (nonatomic,strong) NIMInputEmoticonLayout *layout;
@property (nonatomic,strong) ContainerColorRead *layout;
...
//: @interface PushInputEmoticonManager : NSObject
@interface DirectorManager : NSObject
