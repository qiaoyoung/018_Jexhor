...
- (NSArray *)read:(NSString *)sendText;
{
    ...
    NSArray *names = [self equal:sendText];
    //: NSMutableArray *uids = [[NSMutableArray alloc] init];
    NSMutableArray *uids = [[NSMutableArray alloc] init];
    //: for (NSString *name in names) {
    for (NSString *name in names) {
        //: NIMInputAtItem *item = [self item:name];
        TingMargin *item = [self totalry:name];
        //: if (item)
        if (item)
        {
...
- (NSArray *)equal:(NSString *)sendText
{
