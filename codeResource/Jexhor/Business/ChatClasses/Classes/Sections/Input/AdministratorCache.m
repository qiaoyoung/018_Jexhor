...
- (NSArray *)custom:(NSString *)sendText;
{
    ...
    NSArray *names = [self remote:sendText];
    //: NSMutableArray *uids = [[NSMutableArray alloc] init];
    NSMutableArray *uids = [[NSMutableArray alloc] init];
    //: for (NSString *name in names) {
    for (NSString *name in names) {
        //: NIMInputAtItem *item = [self item:name];
        OpendSessionItem *item = [self button:name];
        //: if (item)
        if (item)
        {
...
- (NSArray *)remote:(NSString *)sendText
{
...
@implementation OpendSessionItem
