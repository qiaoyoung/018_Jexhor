...
@interface FrontwardsCount : NSObject
...
@interface WorstedYarnLayout : NSObject
...
@interface WithTextSearch : NSObject
//: @property (nonatomic,strong) NIMInputEmoticonLayout *layout;
@property (nonatomic,strong) WorstedYarnLayout *layout;
