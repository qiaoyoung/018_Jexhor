...
@implementation UIImage (SearchedControl)

//: - (NSData *)compressQualityWithMaxLength:(NSInteger)maxLength {
- (NSData *)sprechstimme:(NSInteger)maxLength {
...
-(NSData *)compress:(NSUInteger)maxLength{
    // Compress by quality
    //: CGFloat compression = 1;
    CGFloat compression = 1;
    //: NSData *data = UIImageJPEGRepresentation(self, compression);
