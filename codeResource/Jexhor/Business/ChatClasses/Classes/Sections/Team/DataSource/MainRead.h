...
extern NSString * _Nonnull const noti_dataMessage;
//: extern NSString * _Nonnull const kNIMTeamListDataTeamMembersChanged;
extern NSString * _Nonnull const userVideoBarFormat;

//: NS_ASSUME_NONNULL_BEGIN
NS_ASSUME_NONNULL_BEGIN

//: @interface PushTeamListDataManager : NSObject<PushTeamMemberListDataSource>
@interface MainRead : NSObject<ShouldBackground>
