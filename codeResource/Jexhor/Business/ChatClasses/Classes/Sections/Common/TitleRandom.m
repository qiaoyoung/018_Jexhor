...
NSNotificationName const noti_toFieldFormat = @"NIMKitKeyboardWillChangeFrameNotification";
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(versionned:) name:UIKeyboardWillHideNotification object:nil];
    }
    //: return self;
    return self;
}
...
- (void)ofsing:(NSNotification *)notification
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:noti_toFieldFormat object:nil userInfo:notification.userInfo];
}



//: - (void)keyboardWillHide:(NSNotification *)notification
- (void)versionned:(NSNotification *)notification
{
    //: _isVisiable = NO;
    _isVisiable = NO;
    //: _keyboardHeight = 0;
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:appBubbleViewPath object:nil userInfo:notification.userInfo];
}
