...
// __CLOSE_PRINT__
//
//  TutorialDataOrientationControl.m
// Secret
//
...
// __M_A_C_R_O__
//: #import "PushSessionImageContentView.h"
#import "TutorialDataOrientationControl.h"
...
//: @interface PushSessionImageContentView()
@interface TutorialDataOrientationControl()
...
//: @implementation PushSessionImageContentView
@implementation TutorialDataOrientationControl
...
//        [_imageView sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:images ];
    ...
    if (self.model.message.deliveryState == NIMMessageDeliveryStateDelivering) {
        ...
        self.progressView.clean = [[NIMSDK sharedSDK].chatManager messageTransportProgress:self.model.message];
    //: }else{
    }else{
        //: self.progressView.hidden = YES;
        self.progressView.hidden = YES;
