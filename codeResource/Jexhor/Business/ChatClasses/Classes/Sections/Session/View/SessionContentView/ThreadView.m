...
NSString *StringFromBatteryData(Byte *data);


//: icon_receiver_voice_playing_004
Byte dream_lendValue[] = {34, 31, 9, 34, 124, 253, 163, 138, 123, 52, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 239};

//: icon_voice_play_b
Byte noti_petSizeValue[] = {2, 17, 6, 132, 72, 210, 98, 95, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 110, 111, 99, 105, 84};

//: icon_receiver_voice_playing
Byte user_colorValue[] = {75, 27, 4, 207, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 63};

//: icon_receiver_voice_playing_002
Byte showTitleToStructuralValue[] = {96, 31, 4, 234, 50, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 62};

//: icon_voice_plus_b
Byte k_expectTitle[] = {34, 17, 7, 69, 232, 68, 131, 98, 95, 115, 117, 108, 112, 95, 101, 99, 105, 111, 118, 95, 110, 111, 99, 105, 202};

//: icon_receiver_voice_playing_003
Byte appFederalMeasureText[] = {3, 31, 6, 48, 104, 132, 51, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 155};

//: icon_receiver_voice_playing_007
Byte show_educatorText[] = {42, 31, 5, 158, 228, 55, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 80};

//: icon_receiver_voice_playing_001
Byte k_departmentValue[] = {56, 31, 12, 92, 81, 134, 90, 196, 189, 196, 119, 147, 49, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 187};

//: icon_receiver_voice_playing_005
Byte user_pdaName[] = {34, 31, 10, 195, 181, 113, 159, 89, 102, 50, 53, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 208};

//: icon_receiver_voice_playing_006
Byte mPoetValue[] = {38, 31, 10, 248, 107, 77, 36, 40, 149, 43, 54, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 9};

//: icon_receiver_voice_playing_w
Byte main_threeValue[] = {43, 29, 4, 77, 119, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 120};

//: icon_receiver_voice_playing_010
Byte mainPayerData[] = {70, 31, 3, 48, 49, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 247};

//: icon_receiver_voice_playing_008
Byte k_modeName[] = {22, 31, 8, 74, 216, 171, 45, 70, 56, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 247};

//: icon_receiver_voice_playing_009
Byte mCongressionalData[] = {90, 31, 5, 69, 41, 57, 48, 48, 95, 103, 110, 105, 121, 97, 108, 112, 95, 101, 99, 105, 111, 118, 95, 114, 101, 118, 105, 101, 99, 101, 114, 95, 110, 111, 99, 105, 30};
...
- (void)setCombAt:(BOOL)isPlaying
{
    ...
    if (isPlaying) {
        ...
        _voicePlayViewleft.image = [UIImage imageNamed:StringFromBatteryData(k_expectTitle)];
//        _voicePlayView.image = [UIImage imageNamed:@"icon_voice_plus_w"];
        //: _voicePlayView.image = [UIImage imageNamed:@"icon_voice_plus_b"];
        _voicePlayView.image = [UIImage imageNamed:StringFromBatteryData(k_expectTitle)];
    //: }else{
    }else{
        ...
        _voicePlayViewleft.image = [UIImage imageNamed:StringFromBatteryData(noti_petSizeValue)];
//        _voicePlayView.image = [UIImage imageNamed:@"icon_voice_play_w"];
        //: _voicePlayView.image = [UIImage imageNamed:@"icon_voice_play_b"];
        _voicePlayView.image = [UIImage imageNamed:StringFromBatteryData(noti_petSizeValue)];
    }
}

//: - (void)addVoiceView{
- (void)panoramicViewButtonKey{
    ...
    _voicePlayViewleft = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromBatteryData(noti_petSizeValue)]];
    ...
    _voicePlayView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromBatteryData(noti_petSizeValue)]];
    ...
    UIImage *image = [UIImage imageNamed:StringFromBatteryData(main_threeValue)];
    ...
    NSArray *animateNames = @[StringFromBatteryData(k_departmentValue),StringFromBatteryData(showTitleToStructuralValue),StringFromBatteryData(appFederalMeasureText),StringFromBatteryData(dream_lendValue),StringFromBatteryData(user_pdaName),StringFromBatteryData(mPoetValue),StringFromBatteryData(show_educatorText),StringFromBatteryData(k_modeName),StringFromBatteryData(mCongressionalData),StringFromBatteryData(mainPayerData)];
    ...
    _voiceImageViewleft = [[UIImageView alloc] initWithImage:[UIImage imageNamed:StringFromBatteryData(user_colorValue)]];
    //: NSArray *animateNames2 = @[@"icon_receiver_voice_playing_001",@"icon_receiver_voice_playing_002",@"icon_receiver_voice_playing_003",@"icon_receiver_voice_playing_004",@"icon_receiver_voice_playing_005",@"icon_receiver_voice_playing_006",@"icon_receiver_voice_playing_007",@"icon_receiver_voice_playing_008",@"icon_receiver_voice_playing_009",@"icon_receiver_voice_playing_010"];
    NSArray *animateNames2 = @[StringFromBatteryData(k_departmentValue),StringFromBatteryData(showTitleToStructuralValue),StringFromBatteryData(appFederalMeasureText),StringFromBatteryData(dream_lendValue),StringFromBatteryData(user_pdaName),StringFromBatteryData(mPoetValue),StringFromBatteryData(show_educatorText),StringFromBatteryData(k_modeName),StringFromBatteryData(mCongressionalData),StringFromBatteryData(mainPayerData)];
...
- (void)playAudio:(NSString *)filePath didBeganWithError:(NSError *)error {
    ...
    if(filePath && !error) {
        ...
        if (self.content && [self.audioUIDelegate respondsToSelector:@selector(twentyFourHourPeriod)]) {
            //: [self.audioUIDelegate startPlayingAudioUI];
            [self.audioUIDelegate twentyFourHourPeriod];
        }
    }
}
...
Byte * BatteryDataToCache(Byte *data) {
    int aloneView = data[0];
    int undertakeEmergency = data[1];
    int sureDevastating = data[2];
    if (!aloneView) return data + sureDevastating;
    for (int i = 0; i < undertakeEmergency / 2; i++) {
        int begin = sureDevastating + i;
        int end = sureDevastating + undertakeEmergency - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[sureDevastating + undertakeEmergency] = 0;
    return data + sureDevastating;
}

NSString *StringFromBatteryData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)BatteryDataToCache(data)];
}  
