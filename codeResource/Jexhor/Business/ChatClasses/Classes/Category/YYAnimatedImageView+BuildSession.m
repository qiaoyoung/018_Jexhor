...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+BuildSession.m
// Secret
//
...
#import "YYAnimatedImageView+BuildSession.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (BuildSession)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(circled:));
