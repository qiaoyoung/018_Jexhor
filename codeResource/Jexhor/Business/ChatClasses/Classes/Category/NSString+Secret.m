...
- (CGSize)backStreetWithIt:(UIFont *)font{
...
- (NSString *)minIn {
    ...
    NSString * result = [self numbererchange:[Secret highlight].languageTable];
    //: return result;
    return result;
}

//: - (NSString *)nim_localizedWithTable:(NSString *)table {
- (NSString *)numbererchange:(NSString *)table {
    //: NSBundle * languageBundle = [MyUserKit sharedKit].languageBundle;
    NSBundle * languageBundle = [Secret highlight].languageBundle;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self show:languageBundle data:table];
}

//: - (NSString *)nim_localizedByBundle:(NSBundle *)bundle table:(NSString *)table {
- (NSString *)show:(NSBundle *)bundle data:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
