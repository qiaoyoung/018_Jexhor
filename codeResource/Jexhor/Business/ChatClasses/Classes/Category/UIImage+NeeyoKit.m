...
+ (UIImage *)magnitude:(NSString *)imageName indexQuickLength:(NSString *)chartletId{
...
+ (UIImage *)harvestMoon:(NSString *)imageName {
    //: if (!imageName) {
    if (!imageName) {
        //: return nil;
        return nil;
    ...
    NSString *emojiPath = [[SharedContentView sharedManager] getEmojiPath];
...
- (UIImage *)withTing
{
    ...
    CGFloat pixels = [[SizeBackground currentDevice] suggestImagePixels];
...
- (UIImage *)upload: (CGFloat)suggestPixels
{
...
- (UIImage *)belowTing: (CGFloat)maxPixels
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)inputAcross:(CGSize)newSize
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)aboveManagerSize: (CGSize)size
{
...
- (UIImage *)large:(CGSize)targetSize
{
    // 裁剪两边
