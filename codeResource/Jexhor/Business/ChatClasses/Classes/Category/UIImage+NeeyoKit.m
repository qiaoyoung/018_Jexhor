...
+ (UIImage *)view:(NSString *)imageName tap:(NSString *)chartletId{
...
+ (CGSize)input:(CGSize)originSize
                              //: minSize:(CGSize)imageMinSize
                              power:(CGSize)imageMinSize
...
+ (UIImage *)inwards:(NSString *)imageName {
    ...
    NSString *emojiPath = [[ButtonManager sharedManager] getEmojiPath];
...
- (UIImage *)mentalImageUploadAvatarUnwished
{
    //: CGFloat pixels = [[FFFKitDevice currentDevice] suggestImagePixels];
    CGFloat pixels = [[TeamTing currentDevice] suggestImagePixels];
...
- (UIImage *)buttonUpload: (CGFloat)suggestPixels
{
...
- (UIImage *)titleMagnitudeRelationChange: (CGFloat)maxPixels
{
    //: CGFloat width = self.size.width;
    CGFloat width = self.size.width;
    //: CGFloat height= self.size.height;
...
- (UIImage *)keyBackSize:(CGSize)targetSize
{
    // 裁剪两边
