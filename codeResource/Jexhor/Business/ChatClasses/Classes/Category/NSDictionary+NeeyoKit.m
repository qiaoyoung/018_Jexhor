...
@implementation NSDictionary (Secret)

//: - (NSString *)nimkit_jsonString: (NSString *)key
- (NSString *)textDomain: (NSString *)key
{
...
- (NSDictionary *)queryOf: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)bubbleFull: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)bubbleChalkLinePinArrayName: (NSString *)key
{
...
- (long long)fullLong: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (unsigned long long)quantityCan:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (double)heatherMixtureUp: (NSString *)key{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
    if ([object isKindOfClass:[NSString class]] ||
