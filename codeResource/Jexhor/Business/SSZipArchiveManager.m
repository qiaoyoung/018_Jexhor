...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kStableBehindSuper];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kStableBehindSuper];
    ...
    NSString *path = [[MyUserKit sharedKit].emoticonBundle pathForResource:kStableBehindSuper ofType:@".zip"];
    if (!path) {
