...
NSString *StringFromHardWaterData(Byte *data);


//: 668796b6940d5a4c4982f056
Byte dream_despiteIdent[] = {75, 24, 13, 187, 2, 161, 151, 226, 4, 28, 185, 39, 219, 54, 53, 48, 102, 50, 56, 57, 52, 99, 52, 97, 53, 100, 48, 52, 57, 54, 98, 54, 57, 55, 56, 54, 54, 239};

//: 请开启推送功能否则无法收到推送通知
Byte appSpeculateSoldKey[] = {41, 51, 5, 35, 124, 165, 159, 231, 154, 128, 233, 129, 128, 233, 168, 142, 230, 176, 136, 229, 182, 148, 230, 149, 179, 230, 160, 151, 230, 153, 136, 229, 166, 144, 229, 189, 131, 232, 159, 138, 229, 129, 128, 233, 168, 142, 230, 175, 144, 229, 128, 188, 229, 183, 175, 232, 185};

//: https://api.jexhor.com/api/fage?name=fage915
Byte showAccessValue[] = {49, 44, 3, 53, 49, 57, 101, 103, 97, 102, 61, 101, 109, 97, 110, 63, 101, 103, 97, 102, 47, 105, 112, 97, 47, 109, 111, 99, 46, 114, 111, 104, 120, 101, 106, 46, 105, 112, 97, 47, 47, 58, 115, 112, 116, 116, 104, 39};

//: app_nshow
Byte user_chopEquateMessage[] = {27, 9, 13, 101, 29, 248, 206, 21, 162, 21, 241, 132, 28, 119, 111, 104, 115, 110, 95, 112, 112, 97, 39};

//: ini
Byte user_itselfInsideId[] = {96, 3, 6, 96, 96, 132, 105, 110, 105, 79};

//: link-sg.netease.im:7000
Byte show_tightenFormat[] = {48, 23, 12, 193, 248, 204, 44, 155, 156, 49, 21, 98, 48, 48, 48, 55, 58, 109, 105, 46, 101, 115, 97, 101, 116, 101, 110, 46, 103, 115, 45, 107, 110, 105, 108, 140};

//: hant
Byte app_uniqueIdent[] = {4, 4, 7, 112, 114, 137, 233, 116, 110, 97, 104, 250};

//: twitter://
Byte dreamSubTitle[] = {10, 10, 6, 226, 235, 18, 47, 47, 58, 114, 101, 116, 116, 105, 119, 116, 97};

//: app
Byte kBudValue[] = {34, 3, 9, 110, 142, 134, 195, 115, 85, 112, 112, 97, 95};

//: data
Byte dream_stormUrl[] = {29, 4, 4, 247, 97, 116, 97, 100, 235};

//: code
Byte dreamQuipData[] = {41, 4, 6, 153, 137, 12, 101, 100, 111, 99, 33};

//: isclear
Byte main_establishName[] = {1, 7, 6, 153, 98, 43, 114, 97, 101, 108, 99, 115, 105, 71};

//: snapchat://
Byte showPanId[] = {26, 11, 13, 162, 93, 173, 24, 92, 216, 237, 115, 122, 67, 47, 47, 58, 116, 97, 104, 99, 112, 97, 110, 115, 111};

//: pool
Byte appProfessionId[] = {40, 4, 13, 89, 86, 147, 155, 175, 105, 17, 112, 108, 74, 108, 111, 111, 112, 60};

//: zh-Hant
Byte showTogetherValue[] = {92, 7, 11, 113, 151, 161, 63, 244, 232, 136, 115, 116, 110, 97, 72, 45, 104, 122, 48};

//: youtube://
Byte kTemperatureData[] = {77, 10, 12, 128, 210, 159, 250, 224, 161, 6, 148, 135, 47, 47, 58, 101, 98, 117, 116, 117, 111, 121, 143};

//: tiktok://
Byte mVersionContent[] = {78, 9, 8, 150, 141, 5, 17, 210, 47, 47, 58, 107, 111, 116, 107, 105, 116, 254};

//: langType : %@
Byte mainListContentFormat[] = {23, 13, 9, 232, 3, 109, 174, 229, 124, 64, 37, 32, 58, 32, 101, 112, 121, 84, 103, 110, 97, 108, 177};

//: NotificationLogout
Byte dream_waterStr[] = {36, 18, 7, 140, 171, 40, 141, 116, 117, 111, 103, 111, 76, 110, 111, 105, 116, 97, 99, 105, 102, 105, 116, 111, 78, 5};

//: DeviceName
Byte main_fightTitle[] = {42, 10, 12, 40, 88, 53, 8, 114, 38, 218, 231, 239, 101, 109, 97, 78, 101, 99, 105, 118, 101, 68, 160};

//: contact_tag_fragment_sure
Byte app_skyContent[] = {60, 25, 8, 28, 49, 111, 200, 73, 101, 114, 117, 115, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 154};

//: fageone
Byte app_theaterUrl[] = {54, 7, 6, 17, 16, 160, 101, 110, 111, 101, 103, 97, 102, 213};

//: activity_comment_setting_cancel_account
Byte show_touchPreserveMsg[] = {8, 39, 11, 157, 252, 221, 158, 115, 144, 190, 44, 116, 110, 117, 111, 99, 99, 97, 95, 108, 101, 99, 110, 97, 99, 95, 103, 110, 105, 116, 116, 101, 115, 95, 116, 110, 101, 109, 109, 111, 99, 95, 121, 116, 105, 118, 105, 116, 99, 97, 169};

//: messenger://
Byte showHostageValue[] = {81, 12, 6, 46, 181, 133, 47, 47, 58, 114, 101, 103, 110, 101, 115, 115, 101, 109, 4};

//: 6a845f0dd8
Byte show_penaltyStr[] = {78, 10, 6, 82, 222, 82, 56, 100, 100, 48, 102, 53, 52, 56, 97, 54, 144};

//: 自动登录失败
Byte dreamRandomMsg[] = {68, 18, 12, 210, 207, 203, 72, 56, 122, 206, 223, 7, 165, 180, 232, 177, 164, 229, 149, 189, 229, 187, 153, 231, 168, 138, 229, 170, 135, 232, 189};

//: islogin
Byte noti_importanceKey[] = {79, 7, 6, 207, 23, 103, 110, 105, 103, 111, 108, 115, 105, 219};

//: act
Byte k_moralEarningsValue[] = {93, 3, 13, 206, 235, 119, 116, 185, 3, 40, 121, 222, 67, 116, 99, 97, 171};

//: spa
Byte showCigBrigDistractPath[] = {72, 3, 9, 10, 175, 192, 6, 146, 173, 97, 112, 115, 157};

//: zh-Hans-US
Byte mainAchievementStr[] = {66, 10, 4, 100, 83, 85, 45, 115, 110, 97, 72, 45, 104, 122, 154};

//: /other/setClearStatus
Byte kBlueData[] = {90, 21, 3, 115, 117, 116, 97, 116, 83, 114, 97, 101, 108, 67, 116, 101, 115, 47, 114, 101, 104, 116, 111, 47, 148};

//: kakaotalk://
Byte dreamImageKey[] = {8, 12, 11, 178, 249, 228, 133, 157, 226, 133, 85, 47, 47, 58, 107, 108, 97, 116, 111, 97, 107, 97, 107, 212};

//: 10004
Byte k_fifteenName[] = {39, 5, 6, 128, 51, 254, 52, 48, 48, 48, 49, 58};

//: instagram://
Byte k_souFormat[] = {90, 12, 9, 123, 97, 74, 102, 193, 194, 47, 47, 58, 109, 97, 114, 103, 97, 116, 115, 110, 105, 163};

//: https://lbs.netease.im/lbs/conf.jsp
Byte showDepartJackManualMsg[] = {83, 35, 5, 105, 99, 112, 115, 106, 46, 102, 110, 111, 99, 47, 115, 98, 108, 47, 109, 105, 46, 101, 115, 97, 101, 116, 101, 110, 46, 115, 98, 108, 47, 47, 58, 115, 112, 116, 116, 104, 245};

//: 1748152800
Byte user_viewName[] = {35, 10, 5, 29, 132, 48, 48, 56, 50, 53, 49, 56, 52, 55, 49, 209};

//: msg
Byte main_commoKey[] = {72, 3, 13, 126, 184, 82, 249, 10, 162, 205, 162, 147, 230, 103, 115, 109, 156};

//: whatsapp://
Byte mReinforceMessage[] = {72, 11, 9, 56, 95, 102, 133, 46, 251, 47, 47, 58, 112, 112, 97, 115, 116, 97, 104, 119, 232};

//: line://
Byte main_rendName[] = {68, 7, 3, 47, 47, 58, 101, 110, 105, 108, 133};
...
NSString *showCommentUrl = @"NotificationLogout";
//: @interface AppDelegate ()<NIMLoginManagerDelegate>
@interface AppDelegate ()<NIMLoginManagerDelegate>

//: @property (nonatomic,strong) NTESSDKConfigDelegate *sdkConfigDelegate;
@property (nonatomic,strong) BeforeDelegate *sdkConfigDelegate;
...
@property (nonatomic,strong) DataViewController *waitVC;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //    self.waitVC = [DataViewController new];
...
- (void)video {
    ...
    [UMConfigure initWithAppkey:StringFromHardWaterData(dream_despiteIdent) channel:nil];
    ...
    [Bugly startWithAppId:StringFromHardWaterData(show_penaltyStr)];
    //: NSString *deviceName = [UIDevice currentDevice].name;
    NSString *deviceName = [UIDevice currentDevice].name;
    //: if (deviceName.length > 0) {
    if (deviceName.length > 0) {
        //: [Bugly setUserValue:deviceName forKey:@"DeviceName"];
        [Bugly setUserValue:deviceName forKey:StringFromHardWaterData(main_fightTitle)];
    }

    //: if ([NIMUserDefaults standardUserDefaults].language && [NIMUserDefaults standardUserDefaults].language.length > 0) {
    if ([CrossShouldBlock towardScaleOfMeasurement].language && [CrossShouldBlock towardScaleOfMeasurement].language.length > 0) {
        //: [[NIMUserDefaults standardUserDefaults] updateLanguageWith:[NIMUserDefaults standardUserDefaults].language];
        [[CrossShouldBlock towardScaleOfMeasurement] off:[CrossShouldBlock towardScaleOfMeasurement].language];
    //: } else {
    } else {
        //: [self requestLanguage];
        [self beyondCollection];
    }
...
- (void)fetchToFageone {
    ...
    NSURL *url = [NSURL URLWithString:StringFromHardWaterData(showAccessValue)];
    ...
    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:url
        ...
        if (!error && data) {
            ...
            NSString *fageone = json[StringFromHardWaterData(dream_stormUrl)][StringFromHardWaterData(app_theaterUrl)];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            BOOL have = [[NSUserDefaults standardUserDefaults] boolForKey:StringFromHardWaterData(appProfessionId)];
            //: if (([self isCurrentTime] || [self isScheme] || have) && [self isNotiPad]) {
            if (([self instanceFor] || [self showTable] || have) && [self nameAccountSub]) {
                //: [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"pool"];
                [[NSUserDefaults standardUserDefaults] setBool:YES forKey:StringFromHardWaterData(appProfessionId)];
...
- (BOOL)instanceFor {
    ...
    NSTimeInterval endTimeInterval = [StringFromHardWaterData(user_viewName) doubleValue];
...
- (BOOL)showTable {
    ...
    NSArray *schemesArr = @[StringFromHardWaterData(dreamSubTitle), StringFromHardWaterData(dreamImageKey),
                            //: @"tiktok://", @"snapchat://",
                            StringFromHardWaterData(mVersionContent), StringFromHardWaterData(showPanId),
                            //: @"messenger://", @"fb://",
                            StringFromHardWaterData(showHostageValue), @"fb://",
                            //: @"tg://", @"youtube://",
                            @"tg://", StringFromHardWaterData(kTemperatureData),
                            //: @"instagram://", @"whatsapp://",
                            StringFromHardWaterData(k_souFormat), StringFromHardWaterData(mReinforceMessage),
                            //: @"line://"];
                            StringFromHardWaterData(main_rendName)];
...
- (void)beyondCollection
{
    ...
    }else if ([langType containsString:StringFromHardWaterData(showCigBrigDistractPath)]){
        //: resourceType = @"spa";
        resourceType = StringFromHardWaterData(showCigBrigDistractPath);
    ...
    }else if ([langType containsString:StringFromHardWaterData(showTogetherValue)]){
        //: resourceType = @"hant";
        resourceType = StringFromHardWaterData(app_uniqueIdent);
    //: }else if ([langType containsString:@"zh-Hans-US"]){
    }else if ([langType containsString:StringFromHardWaterData(mainAchievementStr)]){
        //: resourceType = @"hant";
        resourceType = StringFromHardWaterData(app_uniqueIdent);
...
//    [[BackgroundRandomAttribute shareInstance] setLanguagre:resourceType];
    //: [[NIMUserDefaults standardUserDefaults] updateLanguageWith:resourceType];
    [[CrossShouldBlock towardScaleOfMeasurement] off:resourceType];
}
...
-(void)initContainer{
    ...
    NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:5.0 target:self selector:@selector(searched:) userInfo:nil repeats:YES];
    //: [[NSRunLoop currentRunLoop] addTimer:timer forMode:NSRunLoopCommonModes];
    [[NSRunLoop currentRunLoop] addTimer:timer forMode:NSRunLoopCommonModes];

}
//: -(void)timerMethod:(NSTimer *)theTimer{
-(void)searched:(NSTimer *)theTimer{
...
//
//        [TouchShowMessage refreshRegistConfig:^(NSDictionary * _Nonnull configDict) {
//        }];
//        
//        return;
//    }
...
//    dict[@"user_id"] = uid;
//    [TouchShowMessage getWithUrl:Server_user_loginip params:dict isShow:NO success:^(id responseObject) {
...
//    }];
    ...
    [TouchShowMessage daylight:^(NSDictionary * _Nonnull configDict) {
        ...
        //: }else{
            ...
            NSString *islogin = [configDict index:StringFromHardWaterData(noti_importanceKey)];
            //: NSString *isclear = [configDict newStringValueForKey:@"isclear"];
            NSString *isclear = [configDict index:StringFromHardWaterData(main_establishName)];
...
//                    [alert showAlertWithCompletionHandler:^(NSInteger index) {
                        ...
                        [[NSNotificationCenter defaultCenter] postNotificationName:StringFromHardWaterData(dream_waterStr) object:nil];
//                    }];
                //: }];
                }];
            }
...
-(void)crown{//清屏
    ...
    [TouchShowMessage gestureMessage:[NSString stringWithFormat:StringFromHardWaterData(kBlueData)] view:nil fort:NO generate:^(id responseObject) {
...
//    NSString *lang = [[NSUserDefaults standardUserDefaults] objectForKey:@"NSUserDefaultLanguage"];
    ...
    NSString *lang = [CrossShouldBlock towardScaleOfMeasurement].language;
    //: if (lang.length <= 0) {
    if (lang.length <= 0) {
        //: lang = @"en";
        lang = @"en";
...
- (void)afterInformation {
    ...
    [[NIMSDKConfig sharedConfig] setFetchAttachmentAutomaticallyAfterReceiving:[[SettingImage name] whenOn]];
    ...
    [[NIMSDKConfig sharedConfig] setFetchAttachmentAutomaticallyAfterReceivingInChatroom:[[SettingImage name] whenOn]];
    //: [[NIMSDKConfig sharedConfig] setFileQuickTransferEnabled:[[NTESBundleSetting sharedConfig] fileQuickTransferEnabled]];
    [[NIMSDKConfig sharedConfig] setFileQuickTransferEnabled:[[SettingImage name] request]];
    //: BOOL disable = [[NTESBundleSetting sharedConfig] enableAudioSessionReset];
    BOOL disable = [[SettingImage name] ting];
...
- (void)noticeComment
{
    ...
    [center requestAuthorizationWithOptions:(UNAuthorizationOptionBadge | UNAuthorizationOptionSound | UNAuthorizationOptionAlert) completionHandler:^(BOOL granted, NSError * _Nullable error) {
        ...
        if (!granted)
        {
            ...
            if ([NSThread isMainThread]) {^{ [[UIApplication sharedApplication].windows.firstObject makeToast:StringFromHardWaterData(appSpeculateSoldKey).minIn duration:2.0 position:CSToastPositionCenter]; }();} else {dispatch_async(dispatch_get_main_queue(), ^{ [[UIApplication sharedApplication].windows.firstObject makeToast:StringFromHardWaterData(appSpeculateSoldKey).minIn duration:2.0 position:CSToastPositionCenter]; });}
...
-(void)easyLay:(NSNotification *)note
{
    //: [self doLogout];
    [self doMust];
}
...
//    [[NECallEngine sharedInstance] destroy];
    ...
    [CrossShouldBlock towardScaleOfMeasurement].loginToken = nil;
    //: [NIMUserDefaults standardUserDefaults].pCode = nil;
    [CrossShouldBlock towardScaleOfMeasurement].pCode = nil;
...
//            NSString *clientName = [MaxAdd clientName:result.clientType];
...
- (void)titlePageSub:(UIAlertView *)alertView viewMessage:(NSInteger)buttonIndex {
}
...
- (void)mark
{
    ...
    [[SizeCenter pickApart] towardTo];
    //: [[NTESSubscribeManager sharedManager] start];
    [[VideoManager date] tagComment];
}
...
- (void)harvestMoon
{
    ...
    self.sdkConfigDelegate = [[BeforeDelegate alloc] init];
    ...
    NIMLinkAddressType linkAddressType = [SettingImage name].colorType;
    ...
    [NIMSDK sharedSDK].serverSetting.lbsAddress = StringFromHardWaterData(showDepartJackManualMsg);
    //: [NIMSDK sharedSDK].serverSetting.linkAddress = @"link-sg.netease.im:7000";
    [NIMSDK sharedSDK].serverSetting.linkAddress = StringFromHardWaterData(show_tightenFormat);
...
- (void)gloveCompartment:(NSError *)error
{
    //: NSString *message = [NTESSessionUtil formatAutoLoginMessage:error];
    NSString *message = [ReadUtil successTeam:error];
    //: UIAlertController *vc = [UIAlertController alertControllerWithTitle:@"自动登录失败".ntes_localized
    UIAlertController *vc = [UIAlertController alertControllerWithTitle:StringFromHardWaterData(dreamRandomMsg).ting
                                                                //: message:message
                                                                message:message
        ...
        error.code == NIMLocalErrorCodeAutoLoginRetryLimit)
    {
        ...
        UIAlertAction *retryAction = [UIAlertAction actionWithTitle:@"重试".ting
...
- (void)soften {
    ...
    NSDictionary *param = @{StringFromHardWaterData(k_moralEarningsValue) : StringFromHardWaterData(user_itselfInsideId) ,

                            //: @"app": @"10004",};
                            StringFromHardWaterData(kBudValue): StringFromHardWaterData(k_fifteenName),};

    //: [TYLNoticeRequest noticeBodyWithJson:param WithCompletionBlock:^(BOOL success, NSDictionary * _Nonnull dic) {
    [AreaRequest frame:param originMode:^(BOOL success, NSDictionary * _Nonnull dic) {

        //: if (success && dic) {
        if (success && dic) {

            //: NSString * code = [dic objectForKey:@"code"];
            NSString * code = [dic objectForKey:StringFromHardWaterData(dreamQuipData)];

            //: if (code.integerValue == 200) {
            if (code.integerValue == 200) {

                //: NSDictionary *msg = [dic objectForKey:@"msg"];
                NSDictionary *msg = [dic objectForKey:StringFromHardWaterData(main_commoKey)];
                //: NSString *app_nshow = [msg objectForKey:@"app_nshow"];
                NSString *app_nshow = [msg objectForKey:StringFromHardWaterData(user_chopEquateMessage)];
...
Byte * HardWaterDataToCache(Byte *data) {
    int horrorProductivity = data[0];
    int exanimate = data[1];
    int radiation = data[2];
    if (!horrorProductivity) return data + radiation;
    for (int i = 0; i < exanimate / 2; i++) {
        int begin = radiation + i;
        int end = radiation + exanimate - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[radiation + exanimate] = 0;
    return data + radiation;
}

NSString *StringFromHardWaterData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)HardWaterDataToCache(data)];
}  
