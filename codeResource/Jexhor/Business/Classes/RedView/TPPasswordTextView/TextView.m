...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [textField addTarget:self action:@selector(trademarkMax:) forControlEvents:UIControlEventEditingChanged];
...
- (void)notChange {
    ...
    [self trademarkMax:self.textField];
}

//: - (void)showKeyboard {
- (void)progressKeyboard {
...
- (void)trademarkMax:(UITextField *)textField {
