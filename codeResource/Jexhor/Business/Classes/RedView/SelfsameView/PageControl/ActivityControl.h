...
@interface ActivityControl : UIControl
...
/**
 *  The Class of your custom UIView, make sure to respect the TidyView class.
 */
...
- (void)receive:(ActivityControl *)pageControl facingPages:(NSInteger)index;
