...
@property (nonatomic,strong) ShouldButton *chatButton;
...
- (instancetype)initWithShouldConsumer:(NSString *)userId
{
...
- (void)viewDidLoad {
    ...
    self.chatButton = [[ShouldButton alloc] initWithFrame:CGRectZero];
...
- (void)bar:(id)sender
{
    ...
    BlockViewController *vc = [[BlockViewController alloc] initWithSession:session];
