...
- (void)need:(void (^)(BOOL succeed, NSArray <MessageBubblePerson *> *contacts))completcion;
...
- (void)sectionOf:(void (^)(BOOL succeed, NSArray <ContainerPerson *> *contacts, NSArray <NSString *> *keys))completcion;
