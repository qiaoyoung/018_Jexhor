...
@interface MessageBubblePerson : NSObject
...
@property (nonatomic, copy) NSArray <MouthpieceContent *> *phones;
...
@interface MouthpieceContent : NSObject
...
@interface ContainerPerson : NSObject

//: @property (nonatomic, copy) NSString *key;
@property (nonatomic, copy) NSString *key;

//: @property (nonatomic, copy) NSArray <CCCContactPerson *> *persons;
@property (nonatomic, copy) NSArray <MessageBubblePerson *> *persons;
