...
#import "MessageBubblePerson.h"
//: #import "NSString+LJExtension.h"
#import "NSString+With.h"

//: @implementation CCCContactPerson
@implementation MessageBubblePerson

//: - (instancetype)initWithCNContact:(CNContact *)contact {
- (instancetype)initWithJumpingDoingPlace:(CNContact *)contact {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            for (CNLabeledValue *labeledValue in contact.phoneNumbers)
            {
                ...
                if ([MouthpieceContent fromStatus:labeledValue]) {
                    //: NIMContactPhone *phoneModel = [[NIMContactPhone alloc] initWithLabeledValue:labeledValue];
                    MouthpieceContent *phoneModel = [[MouthpieceContent alloc] initWithOfIndex:labeledValue];
...
@implementation MouthpieceContent

//: - (instancetype)initWithLabeledValue:(CNLabeledValue *)labeledValue {
- (instancetype)initWithOfIndex:(CNLabeledValue *)labeledValue {
    //: self = [super init];
    self = [super init];
    //: if (self)
    if (self)
    {
        ...
        self.phone = [NSString text:phoneNumber];
...
+ (BOOL)fromStatus:(CNLabeledValue *)labeledValue {
    //: CNPhoneNumber *phoneValue = labeledValue.value;
    CNPhoneNumber *phoneValue = labeledValue.value;
    //: NSString *phoneNumber = phoneValue.stringValue;
    NSString *phoneNumber = phoneValue.stringValue;
...
@implementation ContainerPerson
