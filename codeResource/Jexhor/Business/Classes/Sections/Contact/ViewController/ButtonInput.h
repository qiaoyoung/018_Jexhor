...
@property (nonatomic, copy) NSArray <FactorPhone *> *phones;
...
@interface FactorPhone : NSObject
...
@interface ImagePerson : NSObject

//: @property (nonatomic, copy) NSString *key;
@property (nonatomic, copy) NSString *key;

//: @property (nonatomic, copy) NSArray <CCCContactPerson *> *persons;
@property (nonatomic, copy) NSArray <ButtonInput *> *persons;
