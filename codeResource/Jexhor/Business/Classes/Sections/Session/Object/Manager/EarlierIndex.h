...
@interface ArtifactAttribute : NSObject
...
@interface EarlierIndex : NSObject
...
- (ArtifactAttribute *)messagesCompletion:(NSMutableArray <NIMMessage *> *)messages
                                          ...
                                          shouldObjectTap:(_Nullable NTESMergeForwardProcess)process
                                       //: completion:(_Nullable NTESMergeForwardResult)completion;
                                       elect:(_Nullable NTESMergeForwardResult)completion;
