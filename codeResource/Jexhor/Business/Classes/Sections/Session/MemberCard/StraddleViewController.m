...
NSString *StringFromInsideDirectIconData(Byte *data);


//: activity_group_member_info2_shenfen
Byte app_errText[] = {22, 35, 65, 12, 176, 184, 217, 35, 50, 59, 123, 202, 162, 164, 181, 170, 183, 170, 181, 186, 160, 168, 179, 176, 182, 177, 160, 174, 166, 174, 163, 166, 179, 160, 170, 175, 167, 176, 115, 160, 180, 169, 166, 175, 167, 166, 175, 76};

//: group_member_info_activity_mute_msg
Byte k_cancelId[] = {53, 35, 19, 10, 234, 109, 238, 128, 69, 140, 122, 133, 130, 136, 131, 114, 128, 120, 128, 117, 120, 133, 114, 124, 129, 121, 130, 114, 116, 118, 135, 124, 137, 124, 135, 140, 114, 128, 136, 135, 120, 114, 128, 134, 122, 84};

//: ic_group_lists
Byte show_colorKey[] = {20, 14, 39, 9, 42, 219, 166, 68, 72, 144, 138, 134, 142, 153, 150, 156, 151, 134, 147, 144, 154, 155, 154, 131};

//: #F6F7FA
Byte kCreateValue[] = {78, 7, 37, 10, 106, 84, 29, 36, 236, 76, 72, 107, 91, 107, 92, 107, 102, 206};

//: personCard_bg
Byte dream_viewFormat[] = {23, 13, 69, 4, 181, 170, 183, 184, 180, 179, 136, 166, 183, 169, 164, 167, 172, 6};

//: icon_me_arrow
Byte k_disappointedIdent[] = {74, 13, 63, 13, 113, 14, 143, 182, 158, 70, 191, 191, 59, 168, 162, 174, 173, 158, 172, 164, 158, 160, 177, 177, 174, 182, 242};

//: #EEEEEE
Byte mainHolderTitle[] = {18, 7, 37, 9, 200, 234, 54, 121, 230, 72, 106, 106, 106, 106, 106, 106, 222};

//: message_remark_name
Byte m_termsKey[] = {74, 19, 12, 5, 129, 121, 113, 127, 127, 109, 115, 113, 107, 126, 113, 121, 109, 126, 119, 107, 122, 109, 121, 113, 32};

//: /user/detail
Byte kImageMsg[] = {74, 12, 29, 7, 41, 84, 142, 76, 146, 144, 130, 143, 76, 129, 130, 145, 126, 134, 137, 81};

//: account
Byte showMainUrl[] = {4, 7, 7, 10, 57, 181, 114, 93, 144, 161, 104, 106, 106, 118, 124, 117, 123, 226};
...
//: #8A8E98
Byte app_povertyNameContent[] = {78, 7, 13, 7, 77, 189, 173, 48, 69, 78, 69, 82, 70, 69, 46};

//: ic_invite
Byte mChartName[] = {57, 9, 7, 6, 229, 154, 112, 106, 102, 112, 117, 125, 112, 123, 108, 126};

//: 本地不存在
Byte k_viewLeaveData[] = {32, 15, 36, 14, 98, 253, 135, 201, 44, 215, 15, 186, 248, 235, 10, 192, 208, 9, 192, 212, 8, 220, 177, 9, 209, 188, 9, 192, 204, 23};

//: modify_activity_modify_success
Byte mJumpContent[] = {89, 30, 24, 14, 50, 195, 73, 40, 232, 193, 88, 172, 168, 225, 133, 135, 124, 129, 126, 145, 119, 121, 123, 140, 129, 142, 129, 140, 145, 119, 133, 135, 124, 129, 126, 145, 119, 139, 141, 123, 123, 125, 139, 139, 73};

//: 移出本群
Byte appGoingMessage[] = {5, 12, 76, 12, 31, 172, 115, 60, 6, 255, 141, 234, 51, 243, 7, 49, 211, 6, 50, 232, 248, 51, 10, 240, 201};

//: data
Byte m_termsCustodyKey[] = {85, 4, 83, 13, 16, 147, 107, 162, 64, 167, 68, 68, 158, 183, 180, 199, 180, 72};

//: user_id
Byte k_actorValue[] = {97, 7, 52, 5, 153, 169, 167, 153, 166, 147, 157, 152, 116};

//: code
Byte userSizeMessage[] = {13, 4, 30, 12, 120, 103, 127, 209, 221, 12, 91, 2, 129, 141, 130, 131, 221};

//: ic_sex_man
Byte dream_deviceTitle[] = {90, 10, 34, 10, 66, 20, 166, 145, 38, 243, 139, 133, 129, 149, 135, 154, 129, 143, 131, 144, 67};

//: back_arrow_bl
Byte user_farViewMessage[] = {99, 13, 84, 7, 231, 12, 206, 182, 181, 183, 191, 179, 181, 198, 198, 195, 203, 179, 182, 192, 8};

//: #2C3042
Byte dreamResembleNameMessage[] = {67, 7, 55, 12, 38, 156, 5, 209, 149, 128, 122, 90, 90, 105, 122, 106, 103, 107, 105, 229};

//: activity_group_member_info2_inviter
Byte noti_statKey[] = {3, 35, 96, 14, 171, 28, 66, 235, 175, 253, 89, 224, 17, 122, 193, 195, 212, 201, 214, 201, 212, 217, 191, 199, 210, 207, 213, 208, 191, 205, 197, 205, 194, 197, 210, 191, 201, 206, 198, 207, 146, 191, 201, 206, 214, 201, 212, 197, 210, 8};

//: group_info_activity_op_failed
Byte kActorPath[] = {3, 29, 28, 4, 131, 142, 139, 145, 140, 123, 133, 138, 130, 139, 123, 125, 127, 144, 133, 146, 133, 144, 149, 123, 139, 140, 123, 130, 125, 133, 136, 129, 128, 183};

//: ic_identity_authentication
Byte notiNameValue[] = {86, 26, 68, 13, 195, 9, 80, 225, 38, 55, 129, 142, 250, 173, 167, 163, 173, 168, 169, 178, 184, 173, 184, 189, 163, 165, 185, 184, 172, 169, 178, 184, 173, 167, 165, 184, 173, 179, 178, 74};

//: #ECECEC
Byte main_frankParticipateName[] = {21, 7, 35, 11, 96, 163, 75, 223, 247, 188, 75, 70, 104, 102, 104, 102, 104, 102, 173};

//: ic_sex_woman
Byte k_juryData[] = {75, 12, 95, 5, 206, 200, 194, 190, 210, 196, 215, 190, 214, 206, 204, 192, 205, 12};

//: #FF483D
Byte k_investorMsg[] = {46, 7, 97, 11, 7, 35, 72, 165, 64, 23, 217, 132, 167, 167, 149, 153, 148, 165, 62};

//: #05D481
Byte mainSustainAffairBelowFormat[] = {6, 7, 59, 5, 121, 94, 107, 112, 127, 111, 115, 108, 61};

//: ic_card_edit
Byte userEliteChartIdent[] = {66, 12, 56, 6, 225, 49, 161, 155, 151, 155, 153, 170, 156, 151, 157, 156, 161, 172, 125};

//: head_default
Byte appActorIdent[] = {89, 12, 98, 11, 171, 180, 174, 174, 220, 173, 146, 202, 199, 195, 198, 193, 198, 199, 200, 195, 215, 206, 214, 224};
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor user:StringFromInsideDirectIconData(kCreateValue)];
...
//    [self refresh];
    ...
    dict[StringFromInsideDirectIconData(k_actorValue)] = self.memberId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [TouchShowMessage gestureMessage:[NSString stringWithFormat:StringFromInsideDirectIconData(kImageMsg)] view:dict fort:NO generate:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict index:StringFromInsideDirectIconData(userSizeMessage)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict already:StringFromInsideDirectIconData(m_termsCustodyKey)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data index:StringFromInsideDirectIconData(showMainUrl)];
...
- (void)objecting:(UISwitch *)switcher
{
...
- (void)demonstrateRead:(NSString *)msg {
    //: if (msg) {
    if (msg) {
...
- (UIView *)userView
{
    ...
    if(!_userView){
        ...
        Bg.image = [UIImage imageNamed:StringFromInsideDirectIconData(dream_viewFormat)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-345)/2, [UIDevice title]+44+20, 345, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromInsideDirectIconData(main_randomKey)];
        ...
        [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromInsideDirectIconData(appActorIdent)]];
        ...
        if (self.user.userInfo.gender == NIMUserGenderMale) {
            ...
            sexImg.image = [UIImage imageNamed:StringFromInsideDirectIconData(dream_deviceTitle)];
        //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
        }else if (self.user.userInfo.gender == NIMUserGenderFemale){
            //: sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
            sexImg.image = [UIImage imageNamed:StringFromInsideDirectIconData(k_juryData)];
        }
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor user:StringFromInsideDirectIconData(dreamResembleNameMessage)];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromInsideDirectIconData(user_farViewMessage)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(alongMessage)];
        ...
        pic1.image = [UIImage imageNamed:StringFromInsideDirectIconData(userEliteChartIdent)];
        ...
        self.labRemark.textColor = [UIColor user:StringFromInsideDirectIconData(app_povertyNameContent)];
        ...
        arrow.image = [UIImage imageNamed:StringFromInsideDirectIconData(k_disappointedIdent)];
        ...
        line1.backgroundColor = [UIColor user:StringFromInsideDirectIconData(main_frankParticipateName)];
        ...
        icon2.image = [UIImage imageNamed:StringFromInsideDirectIconData(notiNameValue)];
        ...
        arrow2.image = [UIImage imageNamed:StringFromInsideDirectIconData(k_disappointedIdent)];
        ...
        line2.backgroundColor = [UIColor user:StringFromInsideDirectIconData(main_frankParticipateName)];
        ...
        icon3.image = [UIImage imageNamed:StringFromInsideDirectIconData(mChartName)];
        ...
        sublab3.font = [UIFont systemFontOfSize:12];
        //: sublab3.textColor = [UIColor colorWithHexString:@"#05D481"];
        sublab3.textColor = [UIColor user:StringFromInsideDirectIconData(mainSustainAffairBelowFormat)];
        //: sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : @"本地不存在".nim_localized;
        sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : StringFromInsideDirectIconData(k_viewLeaveData).minIn;
        ...
        arrow3.image = [UIImage imageNamed:StringFromInsideDirectIconData(k_disappointedIdent)];
        ...
        line3.backgroundColor = [UIColor user:StringFromInsideDirectIconData(main_frankParticipateName)];
        ...
        icon4.image = [UIImage imageNamed:StringFromInsideDirectIconData(show_colorKey)];
        ...
        UISwitch *pushSwitch = [[UISwitch alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width-60-51, 10, 51, 30)];
        //: [pushSwitch setOnTintColor: [UIColor colorWithHexString:@"#05D481"]];
        [pushSwitch setOnTintColor: [UIColor user:StringFromInsideDirectIconData(mainSustainAffairBelowFormat)]];
        //: [pushSwitch addTarget:self action:@selector(updateMute:) forControlEvents:UIControlEventValueChanged];
        [pushSwitch addTarget:self action:@selector(objecting:) forControlEvents:UIControlEventValueChanged];
        ...
        if(canEdit){
            ...
            [self.btnDelete setTitleColor:[UIColor user:StringFromInsideDirectIconData(k_investorMsg)] forState:UIControlStateNormal];
            ...
            self.btnDelete.layer.borderColor = [UIColor user:StringFromInsideDirectIconData(mainHolderTitle)].CGColor;
...
Byte * InsideDirectIconDataToCache(Byte *data) {
    int insideAlly = data[0];
    int titleWhich = data[1];
    Byte alienInput = data[2];
    int aspectBlue = data[3];
    if (!insideAlly) return data + aspectBlue;
    for (int i = aspectBlue; i < aspectBlue + titleWhich; i++) {
        int value = data[i] - alienInput;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[aspectBlue + titleWhich] = 0;
    return data + aspectBlue;
}

NSString *StringFromInsideDirectIconData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)InsideDirectIconDataToCache(data)];
}
