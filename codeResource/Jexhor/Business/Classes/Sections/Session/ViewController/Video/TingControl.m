...
- (void)imageUi{
    ...
    self.thumb.center = [self data:_value];
...
- (void)setBufferProgress:(CGFloat)bufferProgress{
    ...
    bufferProgress = [self locationValid:bufferProgress];
...
- (void)setValue:(CGFloat)value {
    ...
    value = [self locationValid:value];
    //: if (_value == value) {
    if (_value == value) {
        //: return;
        return;
...
- (void)save:(UIImage *)thumbImage language:(UIControlState)state{
