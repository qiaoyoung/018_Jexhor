...
@interface WithController : NSObject

//: @property (nonatomic, weak) id <LYVideoPlayerDelegate> delegate;
@property (nonatomic, weak) id <BarManager> delegate;
