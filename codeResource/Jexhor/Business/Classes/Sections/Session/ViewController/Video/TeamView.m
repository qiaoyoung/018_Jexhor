...
- (void)my{
    ...
    self.thumb.center = [self off:_value];
...
- (void)setBufferProgress:(CGFloat)bufferProgress{
    ...
    bufferProgress = [self noIndex:bufferProgress];
...
- (void)greenTime:(UIImage *)thumbImage thumb:(UIControlState)state{
