...
NSString *StringFromTickData(Byte *data);        


//: #05D481
Byte app_userTitle[] = {39, 7, 62, 5, 120, 229, 242, 247, 6, 246, 250, 243, 216};

//: SELF MATCHES %@
Byte mDramaticallyData[] = {72, 15, 2, 11, 31, 79, 120, 139, 162, 48, 20, 81, 67, 74, 68, 30, 75, 63, 82, 65, 70, 67, 81, 30, 35, 62, 51};

//: systems
Byte appButtonMessage[] = {59, 7, 69, 10, 39, 245, 85, 198, 247, 8, 46, 52, 46, 47, 32, 40, 46, 7};

//: nimtoken
Byte mainCancelCellValue[] = {26, 8, 27, 6, 242, 136, 83, 78, 82, 89, 84, 80, 74, 83, 202};

//: UserAccount
Byte userDeviceId[] = {47, 11, 92, 10, 197, 37, 135, 243, 10, 139, 249, 23, 9, 22, 229, 7, 7, 19, 25, 18, 24, 37};

//: ^[A-Za-z0-9_]{6,18}$
Byte showSustainStr[] = {21, 20, 82, 6, 36, 224, 12, 9, 239, 219, 8, 15, 219, 40, 222, 219, 231, 13, 11, 41, 228, 218, 223, 230, 43, 210, 157};

//: login_activity_login_failed
Byte dream_showData[] = {3, 27, 29, 10, 136, 239, 57, 42, 122, 65, 79, 82, 74, 76, 81, 66, 68, 70, 87, 76, 89, 76, 87, 92, 66, 79, 82, 74, 76, 81, 66, 73, 68, 76, 79, 72, 71, 244};

//: login_icon_user
Byte k_textUrl[] = {3, 15, 68, 10, 112, 134, 209, 165, 60, 101, 40, 43, 35, 37, 42, 27, 37, 31, 43, 42, 27, 49, 47, 33, 46, 252};

//: login_error
Byte kWipePath[] = {84, 11, 72, 10, 127, 217, 4, 131, 184, 123, 36, 39, 31, 33, 38, 23, 29, 42, 42, 39, 42, 242};

//: ic_invisible
Byte noti_belowSaleId[] = {91, 12, 70, 6, 131, 235, 35, 29, 25, 35, 40, 48, 35, 45, 35, 28, 38, 31, 183};

//: deviceid
Byte dream_chiefInfoFormat[] = {87, 8, 38, 14, 107, 64, 172, 2, 14, 218, 153, 77, 62, 223, 62, 63, 80, 67, 61, 63, 67, 62, 126};

//: vpn
Byte show_motMessage[] = {95, 3, 61, 9, 30, 183, 11, 24, 78, 57, 51, 49, 129};

//: password
Byte showPractitionerMaxMsg[] = {2, 8, 8, 6, 159, 227, 104, 89, 107, 107, 111, 103, 106, 92, 203};

//: telname
Byte showViewMsg[] = {58, 7, 46, 8, 42, 84, 188, 245, 70, 55, 62, 64, 51, 63, 55, 43};

//: login_success
Byte mainHorrorPath[] = {60, 13, 97, 13, 161, 164, 135, 40, 235, 23, 120, 168, 73, 11, 14, 6, 8, 13, 254, 18, 20, 2, 2, 4, 18, 18, 133};

//: #8282A7
Byte noti_withHeroName[] = {95, 7, 73, 4, 218, 239, 233, 239, 233, 248, 238, 44};

//: login_icon_pwd
Byte appAspectCenterStr[] = {63, 14, 46, 4, 62, 65, 57, 59, 64, 49, 59, 53, 65, 64, 49, 66, 73, 54, 200};

//: ic_visible
Byte mainViewData[] = {95, 10, 93, 11, 11, 209, 59, 143, 104, 121, 153, 12, 6, 2, 25, 12, 22, 12, 5, 15, 8, 226};

//: tun
Byte dream_motItselfWipeValue[] = {26, 3, 99, 13, 238, 197, 60, 6, 221, 24, 182, 106, 92, 17, 18, 11, 102};

//: type
Byte appToTitle[] = {49, 4, 1, 14, 25, 12, 175, 19, 170, 120, 135, 184, 197, 177, 115, 120, 111, 100, 247};

//: iOS%@
Byte k_laverJuryMessage[] = {68, 5, 28, 9, 89, 68, 10, 226, 98, 77, 51, 55, 9, 36, 216};

//: login_agreement_normal
Byte m_hospitalName[] = {77, 22, 80, 6, 4, 76, 28, 31, 23, 25, 30, 15, 17, 23, 34, 21, 21, 29, 21, 30, 36, 15, 30, 31, 34, 29, 17, 28, 71};

//: activity_register_agree
Byte dreamStatusValue[] = {50, 23, 88, 11, 153, 186, 119, 254, 139, 48, 210, 9, 11, 28, 17, 30, 17, 28, 33, 7, 26, 13, 15, 17, 27, 28, 13, 26, 7, 9, 15, 26, 13, 13, 1};

//: msg
Byte main_withFormat[] = {80, 3, 34, 11, 238, 46, 125, 243, 9, 82, 48, 75, 81, 69, 164};

//: data
Byte notiHolderMessage[] = {13, 4, 79, 8, 140, 13, 155, 172, 21, 18, 37, 18, 79};

//: register_account_activity_account
Byte mSnapMessageStr[] = {66, 33, 39, 12, 150, 24, 129, 77, 224, 70, 166, 51, 75, 62, 64, 66, 76, 77, 62, 75, 56, 58, 60, 60, 72, 78, 71, 77, 56, 58, 60, 77, 66, 79, 66, 77, 82, 56, 58, 60, 60, 72, 78, 71, 77, 149};

//: activity_login_login
Byte show_panFormat[] = {31, 20, 13, 6, 255, 221, 84, 86, 103, 92, 105, 92, 103, 108, 82, 95, 98, 90, 92, 97, 82, 95, 98, 90, 92, 97, 48};

//: login_logo
Byte mainHostilePath[] = {16, 10, 85, 14, 38, 34, 100, 233, 153, 12, 234, 140, 44, 108, 23, 26, 18, 20, 25, 10, 23, 26, 18, 26, 234};

//: activity_register_title
Byte m_insideCellUrl[] = {12, 23, 66, 6, 71, 14, 31, 33, 50, 39, 52, 39, 50, 55, 29, 48, 35, 37, 39, 49, 50, 35, 48, 29, 50, 39, 50, 42, 35, 119};
...
//: ppp
Byte showTitleMessage[] = {8, 3, 57, 4, 55, 55, 55, 79};

//: register_account_activity_psw
Byte mDisappointedName[] = {26, 29, 20, 4, 94, 81, 83, 85, 95, 96, 81, 94, 75, 77, 79, 79, 91, 97, 90, 96, 75, 77, 79, 96, 85, 98, 85, 96, 101, 75, 92, 95, 99, 99};

//: #333333
Byte kCellIdent[] = {66, 7, 94, 8, 170, 26, 253, 136, 197, 213, 213, 213, 213, 213, 213, 102};

//: issup
Byte mStatusName[] = {75, 5, 45, 11, 231, 233, 246, 79, 128, 168, 233, 60, 70, 70, 72, 67, 103};

//: token
Byte app_withFrankValue[] = {5, 5, 31, 5, 159, 85, 80, 76, 70, 79, 147};

//: tap
Byte noti_wooAffairData[] = {56, 3, 50, 14, 201, 14, 84, 84, 188, 149, 45, 160, 180, 72, 66, 47, 62, 195};

//: account
Byte m_viewText[] = {23, 7, 81, 9, 123, 44, 115, 149, 202, 16, 18, 18, 30, 36, 29, 35, 206};

//: activity_comment_setting_ys
Byte noti_povertyId[] = {97, 27, 64, 12, 106, 9, 166, 155, 11, 111, 197, 57, 33, 35, 52, 41, 54, 41, 52, 57, 31, 35, 47, 45, 45, 37, 46, 52, 31, 51, 37, 52, 52, 41, 46, 39, 31, 57, 51, 102};

//: /user/login
Byte user_povertyStr[] = {93, 11, 87, 10, 157, 189, 43, 196, 211, 209, 216, 30, 28, 14, 27, 216, 21, 24, 16, 18, 23, 151};

//: #5D5F66
Byte main_saleMessage[] = {88, 7, 25, 12, 157, 235, 159, 63, 182, 236, 75, 224, 10, 28, 43, 28, 45, 29, 29, 90};

//: login_bg
Byte userTapValue[] = {19, 8, 15, 5, 145, 93, 96, 88, 90, 95, 80, 83, 88, 91};

//: ios
Byte showEconomicId[] = {6, 3, 17, 8, 217, 31, 21, 221, 88, 94, 98, 120};

//: activity_login_has_no_account
Byte kShowWithBlackId[] = {29, 29, 87, 4, 10, 12, 29, 18, 31, 18, 29, 34, 8, 21, 24, 16, 18, 23, 8, 17, 10, 28, 8, 23, 24, 8, 10, 12, 12, 24, 30, 23, 29, 40};

//: ^[A-Za-z0-9_]{6,12}$
Byte main_inputStr[] = {35, 20, 65, 13, 26, 120, 141, 13, 5, 105, 219, 137, 169, 29, 26, 0, 236, 25, 32, 236, 57, 239, 236, 248, 30, 28, 58, 245, 235, 240, 241, 60, 227, 58};

//: client
Byte m_sodDoingMessage[] = {15, 6, 73, 7, 179, 161, 28, 26, 35, 32, 28, 37, 43, 56};

//: friend_verify_avtivity_net_error
Byte dreamEqualIdent[] = {55, 32, 62, 4, 40, 52, 43, 39, 48, 38, 33, 56, 39, 52, 43, 40, 59, 33, 35, 56, 54, 43, 56, 43, 54, 59, 33, 48, 39, 54, 33, 39, 52, 52, 49, 52, 148};

//: login_activity_login_success
Byte notiSessionPath[] = {25, 28, 51, 6, 191, 90, 57, 60, 52, 54, 59, 44, 46, 48, 65, 54, 67, 54, 65, 70, 44, 57, 60, 52, 54, 59, 44, 64, 66, 48, 48, 50, 64, 64, 29};

//: code
Byte mainNorthernMsg[] = {37, 4, 19, 14, 56, 81, 206, 18, 238, 153, 153, 58, 125, 98, 80, 92, 81, 82, 152};

//: #999999
Byte app_positionData[] = {12, 7, 43, 9, 183, 150, 82, 87, 90, 248, 14, 14, 14, 14, 14, 14, 89};

//: activity_login_welcome
Byte mainItselfMessage[] = {24, 22, 76, 11, 92, 96, 180, 93, 5, 194, 246, 21, 23, 40, 29, 42, 29, 40, 45, 19, 32, 35, 27, 29, 34, 19, 43, 25, 32, 23, 35, 33, 25, 125};

//: UserPassWord
Byte appSnapColorText[] = {46, 12, 76, 10, 140, 99, 54, 198, 249, 31, 9, 39, 25, 38, 4, 21, 39, 39, 11, 35, 38, 24, 73};

//: NotificationLogout
Byte dream_iconFormat[] = {69, 18, 86, 14, 186, 138, 19, 35, 239, 113, 40, 142, 42, 66, 248, 25, 30, 19, 16, 19, 13, 11, 30, 19, 25, 24, 246, 25, 17, 25, 31, 30, 30};

//: login_agreement_press
Byte m_standingMsg[] = {97, 21, 51, 9, 7, 179, 213, 222, 101, 57, 60, 52, 54, 59, 44, 46, 52, 63, 50, 50, 58, 50, 59, 65, 44, 61, 63, 50, 64, 64, 212};

//: __SCOPED__
Byte show_farHostileKey[] = {64, 10, 32, 11, 145, 27, 174, 168, 123, 172, 28, 63, 63, 51, 35, 47, 48, 37, 36, 63, 63, 70};

//: lang
Byte noti_upText[] = {90, 4, 10, 7, 53, 142, 99, 98, 87, 100, 93, 53};

// __DEBUG__
// __CLOSE_PRINT__
//
//  TapMaxViewController.m
//  NIMDemo
//
...
- (void)viewDidLoad {
    ...
    [MakeManager should].loginVC = self;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(shoulds:) name:StringFromTickData(noti_mageName) object:nil];
...
- (void)lab {
    ...
    if (userDefaults.language && userDefaults.language.length <= 0) {
        ...
        [TouchShowMessage ambages:^(NSDictionary * _Nonnull configDict) {//处理第一次启动语言问题
            //: if (configDict.allKeys.count > 0) {
            if (configDict.allKeys.count > 0) {
                //: NIMUserDefaults *userDefaults = [NIMUserDefaults standardUserDefaults];
                CrossShouldBlock *userDefaults = [CrossShouldBlock towardScaleOfMeasurement];
                //: NSString *lang = [configDict newStringValueForKey:@"lang"];
                NSString *lang = [configDict index:StringFromTickData(noti_upText)];
...
- (void)fromSave {
    ...
    if (![ColorCounterval signal].isRequestAutoLoginFinish){
        //: return;
        return;
    }

    //: if (![NIMUserDefaults standardUserDefaults].autoLogin.boolValue){
    if (![CrossShouldBlock towardScaleOfMeasurement].autoLogin.boolValue){
        //: [self initUI];
        [self initRange];
        //: return;
        return;
    ...
    if ([CrossShouldBlock towardScaleOfMeasurement].accid.length > 0){
        //: [self initUI];
        [self initRange];
        //: return;
        return;
    ...
    if ([ColorCounterval signal].isloading){
        //: return;
        return;
    }
    //: [CCCAutoLoginManager sharedManager].isloading = YES;
    [ColorCounterval signal].isloading = YES;

    //: [SVProgressHUD show];
    [SVProgressHUD show];

    //: [ZCHttpManager refreshGenerateUser:^(NSDictionary * _Nonnull data) {
    [TouchShowMessage screenIcon:^(NSDictionary * _Nonnull data) {

        //: if (data.allKeys.count > 0) {
        if (data.allKeys.count > 0) {

            //: NSString *nimtoken = [data newStringValueForKey:@"nimtoken"];
            NSString *nimtoken = [data index:StringFromTickData(mainCancelCellValue)];
            //: NSString *accid = [data newStringValueForKey:@"id"];
            NSString *accid = [data index:@"id"];
            //: NSString *accountName = [data newStringValueForKey:@"account"];
            NSString *accountName = [data index:StringFromTickData(m_viewText)];
            //: NSString *loginToken = [data newStringValueForKey:@"token"];
            NSString *loginToken = [data index:StringFromTickData(app_withFrankValue)];
            //: NSString *issup = [data newStringValueForKey:@"issup"];
            NSString *issup = [data index:StringFromTickData(mStatusName)];


            //: [NIMUserDefaults standardUserDefaults].loginToken = loginToken;
            [CrossShouldBlock towardScaleOfMeasurement].loginToken = loginToken;
            //: [NIMUserDefaults standardUserDefaults].accid = accid;
            [CrossShouldBlock towardScaleOfMeasurement].accid = accid;
            //: [NIMUserDefaults standardUserDefaults].nimToken = nimtoken;
            [CrossShouldBlock towardScaleOfMeasurement].nimToken = nimtoken;
            //: [NIMUserDefaults standardUserDefaults].accountName = accountName;
            [CrossShouldBlock towardScaleOfMeasurement].accountName = accountName;
            //: [NIMUserDefaults standardUserDefaults].issup = issup;
            [CrossShouldBlock towardScaleOfMeasurement].issup = issup;
            ...
            [SVProgressHUD dismissWithDelay:0.1 completion:^{
                ...
                [ColorCounterval signal].isloading = NO;
                ...
                MaxVoice *sdkData = [[MaxVoice alloc] init];
                ...
                [[MessageImage frameManager] setCurrentLoginData:sdkData];

                //: [[[NIMSDK sharedSDK] loginManager] autoLogin:loginData];
                [[[NIMSDK sharedSDK] loginManager] autoLogin:loginData];

                //: NTESMainTabController * mainTab = [[NTESMainTabController alloc] initWithNibName:nil bundle:nil];
                BecharmBarController * mainTab = [[BecharmBarController alloc] initWithNibName:nil bundle:nil];
...
-(void)shoulds:(NSNotification *)notification{
    //: NSDictionary *dict = notification.object;
    NSDictionary *dict = notification.object;
    //: _usernameTextField.text = [dict newStringValueForKey:@"UserAccount"];
    _usernameTextField.text = [dict index:StringFromTickData(userDeviceId)];
    //: _passwordTextField.text = [dict newStringValueForKey:@"UserPassWord"];
    _passwordTextField.text = [dict index:StringFromTickData(appSnapColorText)];
...
- (void)initRange{
    ...
    _logoImageView = [[UIImageView alloc] initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-120)/2, (44.0f + [UIDevice title])+10, 120, 120)];
    ...
    _logoImageView.image = [UIImage imageNamed:StringFromTickData(mainHostilePath)];
    ...
    self.titleImg.image = [UIImage imageNamed:StringFromTickData(k_textUrl)];
    ...
    if ([CrossShouldBlock towardScaleOfMeasurement].accountName && [CrossShouldBlock towardScaleOfMeasurement].accountName.length > 0){
        //: _usernameTextField.text = [NIMUserDefaults standardUserDefaults].accountName;
        _usernameTextField.text = [CrossShouldBlock towardScaleOfMeasurement].accountName;
    }
    ...
    self.titleImg2.image = [UIImage imageNamed:StringFromTickData(appAspectCenterStr)];
    ...
    _passwordTextField.textColor = [UIColor user:StringFromTickData(kCellIdent)];
...
//    self.passwordTextField.delegate = self;
    ...
    [self.secureButton setImage:[UIImage imageNamed:StringFromTickData(mainViewData)] forState:UIControlStateNormal];
    //: [self.secureButton setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateSelected];
    [self.secureButton setImage:[UIImage imageNamed:StringFromTickData(noti_belowSaleId)] forState:UIControlStateSelected];
//    self.secureButton.hidden = YES;
    ...
    _loginButton.backgroundColor = [UIColor user:StringFromTickData(app_userTitle)];
...
//    _registerButton.backgroundColor = ThemeColor;
    ...
    [_registerButton setTitleColor:[UIColor user:StringFromTickData(app_userTitle)] forState:UIControlStateNormal];
...
//    _registerButton.layer.cornerRadius = 16;
    ...
    [_agreementButton setImage:[UIImage imageNamed:StringFromTickData(m_hospitalName)] forState:UIControlStateNormal];
    //: [_agreementButton setImage:[UIImage imageNamed:@"login_agreement_press"] forState:UIControlStateSelected];
    [_agreementButton setImage:[UIImage imageNamed:StringFromTickData(m_standingMsg)] forState:UIControlStateSelected];
...
- (void)enableInstallment:(UIButton *)sender {
    ...
    if (sender.selected) { // 按下去了就是明文
        ...
        [sender setImage:[UIImage imageNamed:StringFromTickData(noti_belowSaleId)] forState:UIControlStateNormal];
    ...
    //: } else { 
        ...
        [sender setImage:[UIImage imageNamed:StringFromTickData(mainViewData)] forState:UIControlStateNormal];
...
-(YYLabel *)protocolLabel{
    ...
    if (!_protocolLabel) {
        ...
        [text1 yy_setTextHighlightRange:NSMakeRange(0, originText.length)//设置点击的位置
                                  ...
                                  color:[UIColor user:StringFromTickData(app_userTitle)]
...
-(YYLabel *)registLabel{
    ...
    if (!_registLabel) {
        ...
        text1.yy_color = [UIColor user:StringFromTickData(noti_withHeroName)];
...
-(void)title:(NSString*)account event_strong:(NSString *)password{
...
- (BOOL)multiplicity
{
    ...
    NSDictionary *dict = CFBridgingRelease(CFNetworkCopySystemProxySettings());
        ...
        NSArray *keys = [dict[StringFromTickData(show_farHostileKey)]allKeys];
        //: for (NSString *key in keys) {
        for (NSString *key in keys) {
            //: if ([key rangeOfString:@"tap"].location != NSNotFound ||
            if ([key rangeOfString:StringFromTickData(noti_wooAffairData)].location != NSNotFound ||
                //: [key rangeOfString:@"tun"].location != NSNotFound ||
                [key rangeOfString:StringFromTickData(dream_motItselfWipeValue)].location != NSNotFound ||
                //: [key rangeOfString:@"ppp"].location != NSNotFound){
                [key rangeOfString:StringFromTickData(showTitleMessage)].location != NSNotFound){
                //: return YES;
                return YES;
            }
        }
...
- (BOOL)titlePath:(NSString *)input {
    //: NSString *pattern = @"^[A-Za-z0-9_]{6,12}$";
    NSString *pattern = StringFromTickData(main_inputStr);

    //: NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", pattern];
    NSPredicate *predicate = [NSPredicate predicateWithFormat:StringFromTickData(mDramaticallyData), pattern];
    //: return [predicate evaluateWithObject:input];
    return [predicate evaluateWithObject:input];
}
//: - (BOOL)isPSDValidString:(NSString *)input {
- (BOOL)pull:(NSString *)input {
    //: NSString *pattern = @"^[A-Za-z0-9_]{6,18}$";
    NSString *pattern = StringFromTickData(showSustainStr);
...
//    }
    ...
    [dict setObject:StringFromTickData(showEconomicId) forKey:StringFromTickData(m_sodDoingMessage)];
    //: [dict setObject:@"1" forKey:@"type"];
    [dict setObject:@"1" forKey:StringFromTickData(appToTitle)];
    //: [dict setObject:_usernameTextField.text forKey:@"account"];
    [dict setObject:_usernameTextField.text forKey:StringFromTickData(m_viewText)];
    //: [dict setObject:_passwordTextField.text forKey:@"password"];
    [dict setObject:_passwordTextField.text forKey:StringFromTickData(showPractitionerMaxMsg)];
    //: [dict setObject:[NSString stringWithFormat:@"iOS%@",[ZCHttpRequestHeader deviceVersion]] forKey:@"telname"];
    [dict setObject:[NSString stringWithFormat:StringFromTickData(k_laverJuryMessage),[SharedLayerHeader ofVersion]] forKey:StringFromTickData(showViewMsg)];
    //: [dict setObject:[ZCHttpRequestHeader getIOSVersion] forKey:@"systems"];
    [dict setObject:[SharedLayerHeader versionLabelEmpty] forKey:StringFromTickData(appButtonMessage)];
    //: [dict setObject:[SNDevice deviceIUUID] forKey:@"deviceid"];
    [dict setObject:[DemonstrateDevice replaceView] forKey:StringFromTickData(dream_chiefInfoFormat)];

    //: [dict setObject:[self isVPNConnected]?@"1":@"0" forKey:@"vpn"];
    [dict setObject:[self multiplicity]?@"1":@"0" forKey:StringFromTickData(show_motMessage)];
    ...
    [TouchShowMessage gestureMessage:[NSString stringWithFormat:StringFromTickData(user_povertyStr)] view:dict fort:NO generate:^(id responseObject) {
        ...
        NSString *code = [resultDict index:StringFromTickData(mainNorthernMsg)];
        //: NSString *msg = [resultDict newStringValueForKey:@"msg"];
        NSString *msg = [resultDict index:StringFromTickData(main_withFormat)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {

            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict already:StringFromTickData(notiHolderMessage)];
            //: __block NSString *nimtoken = [data newStringValueForKey:@"nimtoken"];
            __block NSString *nimtoken = [data index:StringFromTickData(mainCancelCellValue)];
            //: __block NSString *accid = [data newStringValueForKey:@"id"];
            __block NSString *accid = [data index:@"id"];

            //: [NIMUserDefaults standardUserDefaults].loginToken = [data newStringValueForKey:@"token"];
            [CrossShouldBlock towardScaleOfMeasurement].loginToken = [data index:StringFromTickData(app_withFrankValue)];
            //: [NIMUserDefaults standardUserDefaults].accid = [data newStringValueForKey:@"id"];
            [CrossShouldBlock towardScaleOfMeasurement].accid = [data index:@"id"];
            ...
            [[[NIMSDK sharedSDK] loginManager] login:accid token:nimtoken completion:^(NSError * _Nullable error) {
                ...
                [self.view makeToast:[BackgroundRandomAttribute content:StringFromTickData(notiSessionPath)] duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromTickData(mainHorrorPath)] style:style completion:nil];
                    ...
                    [CrossShouldBlock towardScaleOfMeasurement].accountName = _usernameTextField.text;
                    //: [NIMUserDefaults standardUserDefaults].pCode = _passwordTextField.text;
                    [CrossShouldBlock towardScaleOfMeasurement].pCode = _passwordTextField.text;
...
//            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter];
            ...
            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromTickData(kWipePath)] style:style completion:nil];
        }
...
Byte * TickDataToCache(Byte *data) {
    int iconBlue = data[0];
    int mainView = data[1];
    Byte devicePull = data[2];
    int bornCold = data[3];
    if (!iconBlue) return data + bornCold;
    for (int i = bornCold; i < bornCold + mainView; i++) {
        int value = data[i] + devicePull;
        if (value > 255) {
            value -= 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[bornCold + mainView] = 0;
    return data + bornCold;
}

NSString *StringFromTickData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)TickDataToCache(data)];
}
