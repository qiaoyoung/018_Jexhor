...
//: login_success
Byte dreamEnableMsg[] = {42, 13, 6, 150, 94, 201, 115, 115, 101, 99, 99, 117, 115, 95, 110, 105, 103, 111, 108, 13};

//: msg
Byte appDirectDepartName[] = {24, 3, 12, 243, 128, 158, 62, 161, 23, 128, 9, 18, 103, 115, 109, 141};

//: friend_verify_avtivity_net_error
Byte userImageDismissName[] = {88, 32, 5, 3, 170, 114, 111, 114, 114, 101, 95, 116, 101, 110, 95, 121, 116, 105, 118, 105, 116, 118, 97, 95, 121, 102, 105, 114, 101, 118, 95, 100, 110, 101, 105, 114, 102, 49};

//: register_account_activity_account
Byte mainUserName[] = {48, 33, 5, 6, 248, 116, 110, 117, 111, 99, 99, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 110, 117, 111, 99, 99, 97, 95, 114, 101, 116, 115, 105, 103, 101, 114, 31};

//: newpass
Byte dreamPractitionerGoingSessionMessage[] = {35, 7, 7, 36, 143, 27, 105, 115, 115, 97, 112, 119, 101, 110, 170};

//: oldpass
Byte app_disappointedKey[] = {71, 7, 4, 143, 115, 115, 97, 112, 100, 108, 111, 144};

//: ic_invisible
Byte appVileUrl[] = {81, 12, 4, 119, 101, 108, 98, 105, 115, 105, 118, 110, 105, 95, 99, 105, 215};

//: login_error
Byte notiSodValue[] = {15, 11, 12, 110, 201, 29, 221, 99, 244, 231, 106, 55, 114, 111, 114, 114, 101, 95, 110, 105, 103, 111, 108, 3};

//: back_arrow_bl
Byte notiDisplayTickFormat[] = {1, 13, 8, 192, 187, 101, 81, 234, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 237};

//: #05D481
Byte kMageId[] = {4, 7, 8, 155, 23, 21, 141, 34, 49, 56, 52, 68, 53, 48, 35, 136};

//: #333333
Byte kNorthernNameTitle[] = {62, 7, 10, 229, 154, 49, 233, 238, 21, 251, 51, 51, 51, 51, 51, 51, 35, 116};

//: safe_bind_phone_icon
Byte appAffairMsg[] = {17, 20, 8, 80, 158, 173, 162, 13, 110, 111, 99, 105, 95, 101, 110, 111, 104, 112, 95, 100, 110, 105, 98, 95, 101, 102, 97, 115, 104};

//: saft_bind_account
Byte show_errPath[] = {5, 17, 6, 198, 10, 34, 116, 110, 117, 111, 99, 99, 97, 95, 100, 110, 105, 98, 95, 116, 102, 97, 115, 16};

//: contact_list_activity_complete
Byte mainDepartMsg[] = {4, 30, 9, 239, 42, 77, 178, 157, 202, 101, 116, 101, 108, 112, 109, 111, 99, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 116, 115, 105, 108, 95, 116, 99, 97, 116, 110, 111, 99, 49};

//: renewpass
Byte mainRoughFormat[] = {61, 9, 6, 166, 240, 253, 115, 115, 97, 112, 119, 101, 110, 101, 114, 127};

//: ic_visible
Byte notiEconomicData[] = {17, 10, 9, 101, 114, 193, 129, 36, 137, 101, 108, 98, 105, 115, 105, 118, 95, 99, 105, 18};

//: activity_modify_new_again
Byte dream_keyName[] = {99, 25, 9, 127, 246, 152, 240, 129, 197, 110, 105, 97, 103, 97, 95, 119, 101, 110, 95, 121, 102, 105, 100, 111, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 176};

//: type
Byte show_tapMsg[] = {38, 4, 8, 194, 214, 41, 139, 17, 101, 112, 121, 116, 45};

//: /user/modifyPass
Byte dream_wakeMessage[] = {33, 16, 4, 87, 115, 115, 97, 80, 121, 102, 105, 100, 111, 109, 47, 114, 101, 115, 117, 47, 11};

//: account
Byte show_farData[] = {54, 7, 7, 131, 251, 254, 198, 116, 110, 117, 111, 99, 99, 97, 229};

//: login_bg
Byte main_eliteAlienStatTitle[] = {62, 8, 7, 56, 38, 38, 43, 103, 98, 95, 110, 105, 103, 111, 108, 163};

//: #5D5F66
Byte dreamKeyContent[] = {50, 7, 5, 73, 208, 54, 54, 70, 53, 68, 53, 35, 16};

//: activity_safe_setting_modify
Byte m_venueFormat[] = {74, 28, 3, 121, 102, 105, 100, 111, 109, 95, 103, 110, 105, 116, 116, 101, 115, 95, 101, 102, 97, 115, 95, 121, 116, 105, 118, 105, 116, 99, 97, 153};

//: modify_activity_psw_no_same
Byte show_detectiveName[] = {47, 27, 4, 171, 101, 109, 97, 115, 95, 111, 110, 95, 119, 115, 112, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 121, 102, 105, 100, 111, 109, 101};

//: code
Byte k_wipeUrl[] = {22, 4, 12, 86, 151, 67, 206, 94, 192, 187, 204, 236, 101, 100, 111, 99, 64};

//: activity_modify_new
Byte dream_whichValue[] = {19, 19, 4, 111, 119, 101, 110, 95, 121, 102, 105, 100, 111, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 199};
...
- (void)viewDidLoad {
    ...
    bg.image = [UIImage imageNamed:StringFromJumpData(main_eliteAlienStatTitle)];
    ...
    [backButton setImage:[UIImage imageNamed:StringFromJumpData(notiDisplayTickFormat)] forState:(UIControlStateNormal)];
    ...
    UIView *view1 = [[UIView alloc]initWithFrame:CGRectMake(20, (44.0f + [UIDevice title])+15, [[UIScreen mainScreen] bounds].size.width-40, 48)];
    ...
    imgname.image = [UIImage imageNamed:StringFromJumpData(show_errPath)];
...
//    self.textfile_1.delegate = self;
    ...
    imgname2.image = [UIImage imageNamed:StringFromJumpData(appAffairMsg)];
...
//    self.textfile_2.delegate = self;
    ...
    [secureButton1 addTarget:self action:@selector(enableInstallment:) forControlEvents:(UIControlEventTouchUpInside)];
    //: [secureButton1 setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateNormal];
    [secureButton1 setImage:[UIImage imageNamed:StringFromJumpData(appVileUrl)] forState:UIControlStateNormal];
    //: [secureButton1 setImage:[UIImage imageNamed:@"ic_visible"] forState:UIControlStateSelected];
    [secureButton1 setImage:[UIImage imageNamed:StringFromJumpData(notiEconomicData)] forState:UIControlStateSelected];
//    secureButton1.hidden = YES;
    ...
    imgname3.image = [UIImage imageNamed:StringFromJumpData(appAffairMsg)];
...
//    self.textfile_3.delegate = self;
    ...
    [secureButton2 addTarget:self action:@selector(subFor:) forControlEvents:(UIControlEventTouchUpInside)];
    //: [secureButton2 setImage:[UIImage imageNamed:@"ic_invisible"] forState:UIControlStateNormal];
    [secureButton2 setImage:[UIImage imageNamed:StringFromJumpData(appVileUrl)] forState:UIControlStateNormal];
    //: [secureButton2 setImage:[UIImage imageNamed:@"ic_visible"] forState:UIControlStateSelected];
    [secureButton2 setImage:[UIImage imageNamed:StringFromJumpData(notiEconomicData)] forState:UIControlStateSelected];
//    secureButton2.hidden = YES;
    ...
    emptyButton.backgroundColor = [UIColor user:StringFromJumpData(kMageId)];
...
- (void)enableInstallment:(UIButton *)sender
{
    ...
    if (sender.selected) { // 按下去了就是明文
        ...
        [sender setImage:[UIImage imageNamed:StringFromJumpData(notiEconomicData)] forState:UIControlStateNormal];
    ...
    //: } else { 
        ...
        [sender setImage:[UIImage imageNamed:StringFromJumpData(appVileUrl)] forState:UIControlStateNormal];
        //: [UIView animateWithDuration:0.25 animations:^{
        [UIView animateWithDuration:0.25 animations:^{
            //: self.textfile_2.secureTextEntry = YES;
            self.textfile_2.secureTextEntry = YES;
...
-(void)clickText
{
    ...
    [dict setObject:account forKey:StringFromJumpData(show_farData)];
    //: [dict setObject:@"" forKey:@"type"];
    [dict setObject:@"" forKey:StringFromJumpData(show_tapMsg)];
    //: [dict setObject:_textfile_1.text forKey:@"oldpass"];
    [dict setObject:_textfile_1.text forKey:StringFromJumpData(app_disappointedKey)];
    //: [dict setObject:_textfile_2.text forKey:@"newpass"];
    [dict setObject:_textfile_2.text forKey:StringFromJumpData(dreamPractitionerGoingSessionMessage)];
    //: [dict setObject:_textfile_3.text forKey:@"renewpass"];
    [dict setObject:_textfile_3.text forKey:StringFromJumpData(mainRoughFormat)];

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/modifyPass"] params:dict isShow:YES success:^(id responseObject) {
    [TouchShowMessage gestureMessage:[NSString stringWithFormat:StringFromJumpData(dream_wakeMessage)] view:dict fort:YES generate:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *msg = [resultDict newStringValueForKey:@"msg"];
        NSString *msg = [resultDict index:StringFromJumpData(appDirectDepartName)];
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict index:StringFromJumpData(k_wipeUrl)];
        ...
        if (code.integerValue == 0) {
            ...
            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromJumpData(dreamEnableMsg)] style:style completion:nil];
        ...
        //: }else{
            ...
            [self.view makeToast:msg duration:2.0 position:CSToastPositionCenter title:nil image:[UIImage imageNamed:StringFromJumpData(notiSodValue)] style:style completion:nil];
        }
...
Byte * JumpDataToCache(Byte *data) {
    int upwardly = data[0];
    int active = data[1];
    int blackParticipate = data[2];
    if (!upwardly) return data + blackParticipate;
    for (int i = 0; i < active / 2; i++) {
        int begin = blackParticipate + i;
        int end = blackParticipate + active - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[blackParticipate + active] = 0;
    return data + blackParticipate;
}

NSString *StringFromJumpData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)JumpDataToCache(data)];
}  
