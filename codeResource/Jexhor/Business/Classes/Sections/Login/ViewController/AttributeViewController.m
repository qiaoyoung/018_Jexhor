...
NSString *StringFromDistinctionData(DistinctionData *data);


//: contact_tag_fragment_cancel
DistinctionData m_teamStr = (DistinctionData){79, (Byte []){44, 32, 33, 59, 46, 44, 59, 16, 59, 46, 40, 16, 41, 61, 46, 40, 34, 42, 33, 59, 16, 44, 46, 33, 44, 42, 35, 92}, 27, 228, 169, 164, 61};

//: #5D5F66
DistinctionData show_northernIdent = (DistinctionData){243, (Byte []){208, 198, 183, 198, 181, 197, 197, 65}, 7, 225, 81, 148, 218};

//: #05D481
DistinctionData kVeteranMessage = (DistinctionData){67, (Byte []){96, 115, 118, 7, 119, 123, 114, 65}, 7, 187, 56, 173, 231};

//: warm_prompt
DistinctionData kItselfVenueDepartName = (DistinctionData){108, (Byte []){27, 13, 30, 1, 51, 28, 30, 3, 1, 28, 24, 75}, 11, 216, 213, 85, 253};

//: ic_hi
DistinctionData app_atTingMaxIdent = (DistinctionData){206, (Byte []){167, 173, 145, 166, 167, 43}, 5, 206, 233, 9, 85};

//: setting_privacy
DistinctionData showIconUrl = (DistinctionData){76, (Byte []){63, 41, 56, 56, 37, 34, 43, 19, 60, 62, 37, 58, 45, 47, 53, 48}, 15, 234, 184, 128, 69};

//: tag_activity_set
DistinctionData showColdId = (DistinctionData){121, (Byte []){13, 24, 30, 38, 24, 26, 13, 16, 15, 16, 13, 0, 38, 10, 28, 13, 192}, 16, 244, 159, 44, 116};

//: ko-KP
DistinctionData show_territoryUrl = (DistinctionData){28, (Byte []){119, 115, 49, 87, 76, 239}, 5, 154, 60, 249, 130};

//: zh-Hans
DistinctionData dream_laverMsg = (DistinctionData){82, (Byte []){40, 58, 127, 26, 51, 60, 33, 103}, 7, 214, 74, 93, 90};

//: register_avtivity3_avatar
DistinctionData dreamStyleTeamOffPath = (DistinctionData){103, (Byte []){21, 2, 0, 14, 20, 19, 2, 21, 56, 6, 17, 19, 14, 17, 14, 19, 30, 84, 56, 6, 17, 6, 19, 6, 21, 27}, 25, 161, 89, 221, 79};

//: register_good_avater
DistinctionData showTeamPullPath = (DistinctionData){17, (Byte []){99, 116, 118, 120, 98, 101, 116, 99, 78, 118, 126, 126, 117, 78, 112, 103, 112, 101, 116, 99, 212}, 20, 188, 19, 132, 228};

//: #000000
DistinctionData notiDeviceFormat = (DistinctionData){75, (Byte []){104, 123, 123, 123, 123, 123, 123, 120}, 7, 157, 164, 111, 187};

//: icon_photo
DistinctionData m_nuclearText = (DistinctionData){237, (Byte []){132, 142, 130, 131, 178, 157, 133, 130, 153, 130, 230}, 10, 165, 206, 43, 141};

//: zh-Hant
DistinctionData mainCenterPath = (DistinctionData){107, (Byte []){17, 3, 70, 35, 10, 5, 31, 225}, 7, 216, 24, 127, 58};

//: back_arrow_bl
DistinctionData app_buttonMessage = (DistinctionData){39, (Byte []){69, 70, 68, 76, 120, 70, 85, 85, 72, 80, 120, 69, 75, 65}, 13, 156, 176, 38, 83};

//: head_default
DistinctionData mSpaceUrl = (DistinctionData){231, (Byte []){143, 130, 134, 131, 184, 131, 130, 129, 134, 146, 139, 147, 135}, 12, 182, 140, 253, 141};

//: spa
DistinctionData app_veteranMsg = (DistinctionData){192, (Byte []){179, 176, 161, 175}, 3, 157, 2, 105, 221};

//: contact_list_activity_complete
DistinctionData mainDistractColdHeavilyUrl = (DistinctionData){128, (Byte []){227, 239, 238, 244, 225, 227, 244, 223, 236, 233, 243, 244, 223, 225, 227, 244, 233, 246, 233, 244, 249, 223, 227, 239, 237, 240, 236, 229, 244, 229, 97}, 30, 202, 137, 220, 254};

//: hant
DistinctionData appUnderUrl = (DistinctionData){200, (Byte []){160, 169, 166, 188, 190}, 4, 151, 207, 163, 223};

//: message_send_album
DistinctionData userMotTitle = (DistinctionData){254, (Byte []){147, 155, 141, 141, 159, 153, 155, 161, 141, 155, 144, 154, 161, 159, 146, 156, 139, 147, 217}, 18, 255, 113, 43, 147};

//: nickname
DistinctionData k_pickFormat = (DistinctionData){145, (Byte []){255, 248, 242, 250, 255, 240, 252, 244, 46}, 8, 219, 34, 113, 161};

//: login_bg
DistinctionData main_penaltySessionMessage = (DistinctionData){248, (Byte []){148, 151, 159, 145, 150, 167, 154, 159, 239}, 8, 245, 221, 238, 165};

//: user_profile_avtivity_head
DistinctionData showWakePath = (DistinctionData){92, (Byte []){41, 47, 57, 46, 3, 44, 46, 51, 58, 53, 48, 57, 3, 61, 42, 40, 53, 42, 53, 40, 37, 3, 52, 57, 61, 56, 88}, 26, 228, 87, 64, 61};

//: setting_privacy_camera
DistinctionData notiAspectImageMessageValue = (DistinctionData){74, (Byte []){57, 47, 62, 62, 35, 36, 45, 21, 58, 56, 35, 60, 43, 41, 51, 21, 41, 43, 39, 47, 56, 43, 186}, 22, 237, 234, 83, 118};
...
//    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"login_bg"]];
    ...
    bg.image = [UIImage imageNamed:StringFromDistinctionData(&main_penaltySessionMessage)];
    ...
    [self.closeBtn setImage:[UIImage imageNamed:StringFromDistinctionData(&app_buttonMessage)] forState:(UIControlStateNormal)];
...
- (void)initImageArray
{
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 25+[UIDevice title], [[UIScreen mainScreen] bounds].size.width-120, 40)];
    ...
    _aratarImgView.image = [UIImage imageNamed:StringFromDistinctionData(&mSpaceUrl)];
    ...
    usericon.image = [UIImage imageNamed:StringFromDistinctionData(&app_atTingMaxIdent)];
    ...
    [cameraicon setImage:[UIImage imageNamed:StringFromDistinctionData(&m_nuclearText)] forState:(UIControlStateNormal)];
    ...
    tita.textColor = [UIColor user:StringFromDistinctionData(&notiDeviceFormat)];
    ...
    self.registButton.backgroundColor = [UIColor user:StringFromDistinctionData(&kVeteranMessage)];
//    self.registButton.layer.masksToBounds = YES;
    ...
    self.registButton.layer.shadowColor = [UIColor user:StringFromDistinctionData(&kVeteranMessage)].CGColor;
...
//    imagePickerVc.naviBgColor = [KEKESkinColorManager shareInstance].skinColor;
    ...
    //: }else if ([langType containsString:@"ko"]){
        ...
        //: preferredlang = @"ko-KP";
        preferredlang = StringFromDistinctionData(&show_territoryUrl);
    //: }else if ([langType containsString:@"spa"]){
    }else if ([langType containsString:StringFromDistinctionData(&app_veteranMsg)]){
        //: preferredlang = @"es";
        preferredlang = @"es";
    ...
    //: }else if ([langType containsString:@"zh"]){
        ...
        preferredlang = StringFromDistinctionData(&dream_laverMsg);
    ...
    }else if ([langType containsString:StringFromDistinctionData(&appUnderUrl)]){
        //: preferredlang = @"zh-Hant";
        preferredlang = StringFromDistinctionData(&mainCenterPath);
    //: }else{
    }else{
        //: preferredlang = @"en";
        preferredlang = @"en";
...
- (void)rangeDown{
    ...
    [manager.registDict setObject:self.nickName forKey:StringFromDistinctionData(&k_pickFormat)];
...
Byte *DistinctionDataToByte(DistinctionData *data) {
    if (data->dateJury < 127) return data->buttonJury;
    for (int i = 0; i < data->sprechgesang; i++) {
        data->buttonJury[i] ^= data->povertyView;
    }
    data->buttonJury[data->sprechgesang] = 0;
    data->dateJury = 41;
	if (data->sprechgesang >= 3) {
		data->hospital = data->buttonJury[0];
		data->vile = data->buttonJury[1];
		data->amplitudeModulation = data->buttonJury[2];
	}
    return data->buttonJury;
}

NSString *StringFromDistinctionData(DistinctionData *data) {
    return [NSString stringWithUTF8String:(char *)DistinctionDataToByte(data)];
}
