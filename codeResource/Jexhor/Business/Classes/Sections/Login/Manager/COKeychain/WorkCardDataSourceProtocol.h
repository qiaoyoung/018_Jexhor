...
typedef void(^NIMTeamCardRowSelectedBlock)(id <WorkKitSelectCardData> item);
...
@protocol WorkKitCardHeaderData <NSObject>
...
@protocol WorkKitSelectCardData <NSObject>
...
- (NSMutableArray <id <WorkKitSelectCardData>> *)optionItems;
