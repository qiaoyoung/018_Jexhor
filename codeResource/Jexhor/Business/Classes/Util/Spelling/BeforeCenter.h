...
@interface DeviceUnit : NSObject<NSCoding>
...
@interface BeforeCenter : NSObject
{
...
- (DeviceUnit *)unwelcome: (NSString *)source; //全拼，简拼 (全是小写)
//: - (NSString *)firstLetter: (NSString *)input; 
- (NSString *)phonation: (NSString *)input; //首字母
//: @end
@end