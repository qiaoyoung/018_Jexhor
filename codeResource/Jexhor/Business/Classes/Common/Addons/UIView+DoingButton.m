...
#import "UIView+DoingButton.h"
//: #import "SwizzlingDefine.h"
#import "SwizzlingDefine.h"

//: @implementation UIView (Swizzling)
@implementation UIView (DoingButton)
...
- (UIView *)trademarkShadow:(CGPoint)point birdSEyeView:(UIEvent *)event
{
    //: UIView *view = [self swizzling_hitTest:point withEvent:event];
    UIView *view = [self trademarkShadow:point birdSEyeView:event];
    //: if (view) {
    if (view) {
    }
    //: return view;
