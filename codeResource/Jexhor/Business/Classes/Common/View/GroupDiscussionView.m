...
@implementation GroupDiscussionView

//: + (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
+ (instancetype)tingOf:(NSString *)badgeValue{
    //: if (!badgeValue) {
    if (!badgeValue) {
        //: badgeValue = @"";
        badgeValue = @"";
    ...
    GroupDiscussionView *instance = [[GroupDiscussionView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance of:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self assemblage:rect trademark:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self by:rect complete:context];
    }
...
- (CGSize)view:(NSString *)badgeValue{
...
- (CGRect)of:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self view:badgeValue];
...
- (void)assemblage:(CGRect)rect trademark:(CGContextRef)context{
...
- (void)by:(CGRect)rect complete:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
