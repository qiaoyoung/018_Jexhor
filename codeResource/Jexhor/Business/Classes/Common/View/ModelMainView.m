...
@implementation ModelMainView

//: + (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
+ (instancetype)path:(NSString *)badgeValue{
    //: if (!badgeValue) {
    if (!badgeValue) {
        //: badgeValue = @"";
        badgeValue = @"";
    ...
    ModelMainView *instance = [[ModelMainView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance table:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self representation:rect should:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self shrewdContext:rect frame:context];
    }
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self table:badgeValue];
...
- (CGSize)assemblage:(NSString *)badgeValue{
...
- (CGRect)table:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self assemblage:badgeValue];
...
- (void)representation:(CGRect)rect should:(CGContextRef)context{
...
- (void)shrewdContext:(CGRect)rect frame:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
