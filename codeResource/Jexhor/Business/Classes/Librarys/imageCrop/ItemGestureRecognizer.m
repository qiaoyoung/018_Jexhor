...
#import "ItemGestureRecognizer.h"
//: #import <UIKit/UIGestureRecognizerSubclass.h>
#import <UIKit/UIGestureRecognizerSubclass.h>

//: @interface YasicPanGestureRecognizer()
@interface ItemGestureRecognizer()
...
@implementation ItemGestureRecognizer

//: -(instancetype)initWithTarget:(id)target action:(SEL)action inview:(UIView*)view{
-(instancetype)initWithActionOff:(id)target tapVisibleDoing:(SEL)action phoneSession:(UIView*)view{
