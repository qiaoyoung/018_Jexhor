...
static CGFloat const appMoreMessage = 3;

//: @implementation YasicClipAreaLayer
@implementation ImageShapeLayer
...
- (void)drawInContext:(CGContextRef)ctx
{
    ...
    CGContextSetLineWidth(ctx, appMoreMessage);
...
- (void)comment:(NSInteger)cropAreaLeft layer:(NSInteger)cropAreaTop styleShow:(NSInteger)cropAreaRight session:(NSInteger)cropAreaBottom
{
    //: _cropAreaLeft = cropAreaLeft;
    _cropAreaLeft = cropAreaLeft;
    //: _cropAreaRight = cropAreaRight;
