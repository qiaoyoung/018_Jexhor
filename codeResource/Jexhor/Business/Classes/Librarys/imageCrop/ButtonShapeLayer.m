...
static CGFloat const dream_dragValue = 3;

//: @implementation YasicClipAreaLayer
@implementation ButtonShapeLayer
...
- (void)drawInContext:(CGContextRef)ctx
{
    ...
    CGContextSetLineWidth(ctx, dream_dragValue);
...
- (void)cell:(NSInteger)cropAreaLeft nameFor:(NSInteger)cropAreaTop with:(NSInteger)cropAreaRight header:(NSInteger)cropAreaBottom
{
    //: _cropAreaLeft = cropAreaLeft;
    _cropAreaLeft = cropAreaLeft;
    //: _cropAreaRight = cropAreaRight;
