...
@property (nonatomic, strong) RedConfigure *configure;
...
- (instancetype)initWithComment:(CGRect)frame with:(RedConfigure *)configure {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(reloadBy)];
...
+ (instancetype)data:(CGRect)frame evidence:(RedConfigure *)configure {
    ...
    return [[ParadigmView alloc] initWithComment:frame with:configure];
}
...
- (void)drawRect:(CGRect)rect {
    ...
    [self enableRedView:borderX textShould:borderY resolutionFloat:cornerLength excessName:insideExcess show:outsideExcess];
    ...
    [self indoors:borderX by:borderY timeFloat:borderH quick:cornerLength popOpen:insideExcess color:outsideExcess];
    ...
    [self table:borderX part:borderY message:borderW view:cornerLength roundTing:insideExcess outside:outsideExcess];
    ...
    [self messageLink:borderX actionExcess:borderY rightOnOvermuchness:borderW recent:borderH tag:cornerLength date:insideExcess quick:outsideExcess];
}
...
- (void)enableRedView:(CGFloat)borderX textShould:(CGFloat)borderY resolutionFloat:(CGFloat)cornerLength excessName:(CGFloat) insideExcess show:(CGFloat)outsideExcess {
...
- (void)table:(CGFloat)borderX part:(CGFloat)borderY message:(CGFloat)borderW view:(CGFloat)cornerLength roundTing:(CGFloat) insideExcess outside:(CGFloat)outsideExcess {
...
- (void)indoors:(CGFloat)borderX by:(CGFloat)borderY timeFloat:(CGFloat)borderH quick:(CGFloat)cornerLength popOpen:(CGFloat) insideExcess color:(CGFloat)outsideExcess {
...
- (void)messageLink:(CGFloat)borderX actionExcess:(CGFloat)borderY rightOnOvermuchness:(CGFloat)borderW recent:(CGFloat)borderH tag:(CGFloat)cornerLength date:(CGFloat) insideExcess quick:(CGFloat)outsideExcess {
...
- (void)message {
    ...
    if (self.link == nil) {
        ...
        self.link = [CADisplayLink displayLinkWithTarget:[MarketPlaceProxy managerTarget:self] selector:@selector(updateUI)];
