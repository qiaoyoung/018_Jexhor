...
extern __attribute__((visibility ("default"))) NSString *const noti_buttonData;/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const dream_minValue;/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const m_teamData;/** 即时聊天*/
