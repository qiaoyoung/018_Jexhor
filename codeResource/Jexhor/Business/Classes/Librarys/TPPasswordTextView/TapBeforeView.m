...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [textField addTarget:self action:@selector(submits:) forControlEvents:UIControlEventEditingChanged];
...
- (void)submits:(UITextField *)textField {
