...
/**
 *  The Class of your custom UIView, make sure to respect the TitleClickView class.
 */
...
- (void)visible:(MessageView *)pageControl array:(NSInteger)index;
