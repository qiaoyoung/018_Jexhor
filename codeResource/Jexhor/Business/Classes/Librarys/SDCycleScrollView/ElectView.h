...
- (void)text:(ElectView *)cycleScrollView of:(NSInteger)index;

/** 图片滚动回调 */
//: - (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index;
- (void)maturityDate_strong:(ElectView *)cycleScrollView timeIntervalervalShouldIndex:(NSInteger)index;

//: @end
@end

//: @interface SDCycleScrollView : UIView
@interface ElectView : UIView
...
+ (instancetype)session:(CGRect)frame bubbleGroup:(NSArray *)imageURLStringsGroup;
