...
//  github : https://github.com/biggercoffee/ProviderCircle
//
...
@implementation NSString (ProviderCircle)
...
@implementation NSArray (ProviderCircle)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        zxp_swizzleSelector(class, @selector(description), @selector(cleanNumber));
        //: zxp_swizzleSelector(class, @selector(descriptionWithLocale:), @selector(zxp_descriptionWithLocale:));
        zxp_swizzleSelector(class, @selector(descriptionWithLocale:), @selector(searches:));
        //: zxp_swizzleSelector(class, @selector(descriptionWithLocale:indent:), @selector(zxp_descriptionWithLocale:indent:));
        zxp_swizzleSelector(class, @selector(descriptionWithLocale:indent:), @selector(message:range:));
    //: });
    });
}
...
@implementation NSDictionary (ProviderCircle)
...
@implementation NSSet (ProviderCircle)
