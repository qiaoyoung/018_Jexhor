...
#import "UIDevice+Change.h"

//: @implementation UIDevice (VGAddition)
@implementation UIDevice (Change)
...
+ (CGFloat)title {
    ...
    if (statusBarHeight <= 0) {
        ...
        CGFloat topPadding = [UIDevice distance];
...
+ (CGFloat)pin {
    ...
    return [UIDevice title] + [UIDevice infoHeight];
}
...
+ (CGFloat)loftiness {
    ...
    return [UIDevice title] + [UIDevice recent];
}
