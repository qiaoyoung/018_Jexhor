...
NSString * const userTouchData = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (Eyeglasses)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(userTouchData), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(userTouchData));
}
...
- (void)colorBubble:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)heritageController {
    ...
    return (UIViewController *)[self sight:self];
}
...
- (UIView *)sessionTing:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView sessionTing:superViewClass];
    }
