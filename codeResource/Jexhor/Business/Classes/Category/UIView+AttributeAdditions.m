...
#import "UIView+AttributeAdditions.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: NSString * const kViewUserInfo = @"kAlertViewUserInfo";
NSString * const showViewUrl = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (AttributeAdditions)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(showViewUrl), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(showViewUrl));
}
...
- (void)voicing:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)bubble {
    ...
    return (UIViewController *)[self accumulation:self];
}
...
- (UIView *)window:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView window:superViewClass];
    }
