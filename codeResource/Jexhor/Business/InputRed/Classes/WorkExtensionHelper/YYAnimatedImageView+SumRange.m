...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+SumRange.m
// MessageContent
//
...
#import "YYAnimatedImageView+SumRange.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (SumRange)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(toLayer:));
