...
@implementation NSString (MessageContent)

//: - (CGSize)nim_stringSizeWithFont:(UIFont *)font{
- (CGSize)recording:(UIFont *)font{
...
- (NSString *)titleBy {
    ...
    NSString * result = [self outsideMessage:[MessageContent secretResolution].languageTable];
    //: return result;
    return result;
}

//: - (NSString *)nim_localizedWithTable:(NSString *)table {
- (NSString *)outsideMessage:(NSString *)table {
    //: NSBundle * languageBundle = [MyUserKit sharedKit].languageBundle;
    NSBundle * languageBundle = [MessageContent secretResolution].languageBundle;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self with:languageBundle view_strong:table];
}

//: - (NSString *)nim_localizedByBundle:(NSBundle *)bundle table:(NSString *)table {
- (NSString *)with:(NSBundle *)bundle view_strong:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
