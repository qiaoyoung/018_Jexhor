 ...
 *
 * 如果您在使用 ExecutiveSessionHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface ExecutiveSessionHelper : NSObject
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)cacheFailure:(NSString *)URL
                        //: parameters:(id)parameters
                        color:(id)parameters
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)sign:(NSString *)URL
                         //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)trademark:(NSString *)URL
                                      //: parameters:(id)parameters
                                      title:(id)parameters
                                            //: name:(NSString *)name
                                            key:(NSString *)name
...
+ (__kindof NSURLSessionTask *)length:(NSString *)URL
                                       //: parameters:(id)parameters
                                       session:(id)parameters
                                             //: name:(NSString *)name
                                             tapButton:(NSString *)name
                                             //: data:(NSData *)data
                                             memoryImage:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         specialSession:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        should:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         need:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          writerSContent:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          withShould:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)option:(NSString *)URL
                                       //: fileDir:(NSString *)fileDir
                                       occurrent:(NSString *)fileDir
                                      //: progress:(YLHttpProgress)progress
                                      grade:(YLHttpProgress)progress
                                       //: success:(void(^)(NSString *filePath))success
                                       size:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setHide:(void(^)(AFHTTPSessionManager *sessionManager))sessionManager;
