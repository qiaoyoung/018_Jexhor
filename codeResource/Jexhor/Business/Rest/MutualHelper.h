 ...
 *
 * 如果您在使用 MutualHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface MutualHelper : NSObject
...
+ (__kindof NSURLSessionTask *)questionManager:(NSString *)URL
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)infoOpenFile:(NSString *)URL
                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)doTable:(NSString *)URL
                         //: parameters:(id)parameters
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)life:(NSString *)URL
                         //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)courseOfActionEnable:(NSString *)URL
                                      //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)file:(NSString *)URL
                                       //: parameters:(id)parameters
                                       optionRed:(id)parameters
                                             //: name:(NSString *)name
                                             keyChild:(NSString *)name
                                             //: data:(NSData *)data
                                             tint:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         vehicleMax:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        image:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         thread:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          mentalImage:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          to:(YLHttpRequestFailed)failure;
...
+ (__kindof NSURLSessionTask *)notice:(NSString *)URL
                                        //: parameters:(id)parameters
                                        mode:(id)parameters
                                              //: name:(NSString *)name
...
+ (__kindof NSURLSessionTask *)should:(NSString *)URL
                                       //: fileDir:(NSString *)fileDir
                                       flunk:(NSString *)fileDir
                                      //: progress:(YLHttpProgress)progress
                                      bubbleMessage:(YLHttpProgress)progress
                                       //: success:(void(^)(NSString *filePath))success
                                       imageUser:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setSend:(void(^)(AFHTTPSessionManager *sessionManager))sessionManager;
