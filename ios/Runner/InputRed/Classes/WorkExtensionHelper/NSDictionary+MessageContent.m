...
@implementation NSDictionary (MessageContent)

//: - (NSString *)nimkit_jsonString: (NSString *)key
- (NSString *)playUp: (NSString *)key
{
...
- (NSDictionary *)send: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSArray *)tag: (NSString *)key
{
    //: NSArray *array = [self nimkit_jsonArray:key];
    NSArray *array = [self ting:key];
    //: BOOL invalid = NO;
    BOOL invalid = NO;
...
- (BOOL)eigenvalueOfAMatrix: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSInteger)withTeam: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (long long)vocalisationLong: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (unsigned long long)highlightAt:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (double)substitute: (NSString *)key{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
    if ([object isKindOfClass:[NSString class]] ||
