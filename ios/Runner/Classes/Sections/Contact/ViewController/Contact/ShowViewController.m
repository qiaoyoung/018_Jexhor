...
//: icon_search_w
Byte user_placeAccountSuccessContent[] = {73, 13, 3, 119, 95, 104, 99, 114, 97, 101, 115, 95, 110, 111, 99, 105, 198};

//: add_friend_activity_input_account
Byte dream_limitValue[] = {23, 33, 9, 229, 34, 151, 130, 184, 224, 116, 110, 117, 111, 99, 99, 97, 95, 116, 117, 112, 110, 105, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 236};

//: uid
Byte dream_shouldTitle[] = {4, 3, 4, 139, 100, 105, 117, 59};

//: /user/recommend
Byte dream_tableTitle[] = {60, 15, 12, 250, 120, 185, 248, 53, 22, 25, 163, 68, 100, 110, 101, 109, 109, 111, 99, 101, 114, 47, 114, 101, 115, 117, 47, 164};

//: #2C3042
Byte kMessageDisableTitle[] = {74, 7, 3, 50, 52, 48, 51, 67, 50, 35, 97};

//: back_arrow_bl
Byte showNameTitle[] = {92, 13, 13, 245, 76, 99, 150, 193, 99, 25, 26, 148, 221, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 26};

//: request_successful
Byte mImageData[] = {65, 18, 11, 136, 40, 57, 190, 7, 2, 194, 98, 108, 117, 102, 115, 115, 101, 99, 99, 117, 115, 95, 116, 115, 101, 117, 113, 101, 114, 148};

//: my_qr
Byte noti_mediaData[] = {62, 5, 11, 195, 183, 222, 61, 211, 3, 225, 205, 114, 113, 95, 121, 109, 254};

//: msg
Byte mainMakeName[] = {61, 3, 5, 10, 160, 103, 115, 109, 24};

//: #EEEEEE
Byte showSuccessOmitName[] = {44, 7, 8, 135, 99, 241, 135, 174, 69, 69, 69, 69, 69, 69, 35, 206};

//: add_friend_activity_add_friend
Byte dream_canEndName[] = {25, 30, 12, 252, 154, 170, 55, 93, 153, 55, 29, 240, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 250};

//: /user/checkAddFriendEx
Byte dreamEndValueViewTitle[] = {46, 22, 8, 126, 185, 215, 114, 124, 120, 69, 100, 110, 101, 105, 114, 70, 100, 100, 65, 107, 99, 101, 104, 99, 47, 114, 101, 115, 117, 47, 103};

//: add_friend_request_fail
Byte mainLabelValue[] = {30, 23, 10, 204, 38, 33, 159, 133, 156, 218, 108, 105, 97, 102, 95, 116, 115, 101, 117, 113, 101, 114, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 239};

//: please_contact_your_administrator
Byte app_hideContent[] = {7, 33, 10, 64, 125, 30, 238, 208, 117, 29, 114, 111, 116, 97, 114, 116, 115, 105, 110, 105, 109, 100, 97, 95, 114, 117, 111, 121, 95, 116, 99, 97, 116, 110, 111, 99, 95, 101, 115, 97, 101, 108, 112, 207};

//: code
Byte k_maxValue[] = {1, 4, 11, 158, 105, 152, 85, 235, 104, 86, 130, 101, 100, 111, 99, 238};

//: #FAF8FD
Byte user_colorData[] = {76, 7, 13, 77, 140, 23, 120, 18, 198, 190, 31, 101, 49, 68, 70, 56, 70, 65, 70, 35, 48};

//: tuid
Byte mainThreadAddName[] = {15, 4, 3, 100, 105, 117, 116, 218};

//: #333333
Byte noti_targetText[] = {12, 7, 4, 179, 51, 51, 51, 51, 51, 51, 35, 205};

//: ic_scan
Byte m_handleText[] = {9, 7, 3, 110, 97, 99, 115, 95, 99, 105, 170};

//: #05D481
Byte notiTableViewValue[] = {1, 7, 12, 90, 148, 167, 90, 5, 150, 190, 48, 114, 49, 56, 52, 68, 53, 48, 35, 181};

//: hot_guys
Byte userHideSessionValue[] = {56, 8, 3, 115, 121, 117, 103, 95, 116, 111, 104, 2};

//: contact_tag_fragment_add_success
Byte show_thanContent[] = {30, 32, 6, 235, 61, 15, 115, 115, 101, 99, 99, 117, 115, 95, 100, 100, 97, 95, 116, 110, 101, 109, 103, 97, 114, 102, 95, 103, 97, 116, 95, 116, 99, 97, 116, 110, 111, 99, 17};

//: data
Byte noti_rowValue[] = {88, 4, 12, 219, 71, 169, 58, 220, 175, 13, 106, 196, 97, 116, 97, 100, 208};

//: fuid
Byte notiVideoData[] = {78, 4, 3, 100, 105, 117, 102, 236};

//: /user/search
Byte mParentValue[] = {27, 12, 8, 54, 185, 216, 222, 113, 104, 99, 114, 97, 101, 115, 47, 114, 101, 115, 117, 47, 247};

//: add_friend_add_fail
Byte app_targetValue[] = {14, 19, 10, 94, 21, 232, 117, 166, 152, 26, 108, 105, 97, 102, 95, 100, 100, 97, 95, 100, 110, 101, 105, 114, 102, 95, 100, 100, 97, 204};

//: group_info_activity_number_no
Byte showNameValue[] = {67, 29, 5, 35, 204, 111, 110, 95, 114, 101, 98, 109, 117, 110, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 234};

//: account
Byte mainViewTitle[] = {19, 7, 13, 170, 118, 106, 57, 103, 54, 197, 166, 19, 195, 116, 110, 117, 111, 99, 99, 97, 226};
...
@interface ShowViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource,DisplayWith>
...
@property (nonatomic ,strong) MyView *MyQRcodeView;
...
- (void)viewDidLoad {
    ...
    [backBtn setImage:[UIImage imageNamed:StringFromByData(showNameTitle)] forState:UIControlStateNormal];
    ...
    UILabel *labNavtitle = [[UILabel alloc]initWithFrame:CGRectMake(0, [UIDevice heightShowStop], [[UIScreen mainScreen] bounds].size.width, 44)];
    ...
    myQrBtn.frame = CGRectMake([[UIScreen mainScreen] bounds].size.width-40-15, [UIDevice heightShowStop], 40, 40);
    //: [myQrBtn addTarget:self action:@selector(QRCodeButtnClick) forControlEvents:UIControlEventTouchUpInside];
    [myQrBtn addTarget:self action:@selector(valueInfo) forControlEvents:UIControlEventTouchUpInside];
    //: [myQrBtn setImage:[UIImage imageNamed:@"my_qr"] forState:UIControlStateNormal];
    [myQrBtn setImage:[UIImage imageNamed:StringFromByData(noti_mediaData)] forState:UIControlStateNormal];
    ...
    UIView *topview = [[UIView alloc]initWithFrame:CGRectMake(0, (44.0f + [UIDevice heightShowStop]), [[UIScreen mainScreen] bounds].size.width, 80)];
    ...
    searchView.backgroundColor = [UIColor ground:StringFromByData(user_colorData)];
    ...
    [btnScan addTarget:self action:@selector(linkFit) forControlEvents:UIControlEventTouchUpInside];
    //: btnScan.frame = CGRectMake(15, 8, 40, 40);
    btnScan.frame = CGRectMake(15, 8, 40, 40);
    //: [btnScan setImage:[UIImage imageNamed:@"ic_scan"] forState:UIControlStateNormal];
    [btnScan setImage:[UIImage imageNamed:StringFromByData(m_handleText)] forState:UIControlStateNormal];
    ...
    [btnSearch setImage:[UIImage imageNamed:StringFromByData(user_placeAccountSuccessContent)] forState:UIControlStateNormal];
    //: [btnSearch addTarget:self action:@selector(doneSearch) forControlEvents:UIControlEventTouchUpInside];
    [btnSearch addTarget:self action:@selector(managerNim) forControlEvents:UIControlEventTouchUpInside];
    //: btnSearch.backgroundColor = [UIColor colorWithHexString:@"#05D481"];
    btnSearch.backgroundColor = [UIColor ground:StringFromByData(notiTableViewValue)];
    ...
    lineview.backgroundColor = [UIColor ground:StringFromByData(showSuccessOmitName)];
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(15, (44.0f + [UIDevice heightShowStop])+110, [[UIScreen mainScreen] bounds].size.width-30, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice heightShowStop])-110) style:UITableViewStyleGrouped];
    ...
    [self.tableView registerClass:[ProviderViewCell class] forCellReuseIdentifier:@"ProviderViewCell"];
...
//    dict[@"user_id"] = self.userId;
    ...
    [TitleManager exhibitBackground:[NSString stringWithFormat:StringFromByData(dream_tableTitle)] queryedBlockOf:nil managerToObject:NO presentResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSLog(@"%@",resultDict);
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict route:StringFromByData(k_maxValue)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {

            //: self.friendList = [resultDict valueObjectForKey:@"data"];
            self.friendList = [resultDict objectColor:StringFromByData(noti_rowValue)];
...
-(void)inputPull:(UITextField *)textField{
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ProviderViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"ProviderViewCell" forIndexPath:indexPath];
...
//    if (isMyFriend) {
        ...
        [self.navigationController pushViewController:vc animated:YES];
//    }else{
//        InsertViewController *vc = [[InsertViewController alloc] initWithUserId:uId];
//        [self.navigationController pushViewController:vc animated:YES];
//    }
...
- (void)inserted:(NSString *)memberId
{
...
- (void)image:(NSString *)userId
{
    ...
    [dict setObject:userId forKey:StringFromByData(mainViewTitle)];
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/search"] params:dict isShow:YES success:^(id responseObject) {
    [TitleManager exhibitBackground:[NSString stringWithFormat:StringFromByData(mParentValue)] queryedBlockOf:dict managerToObject:YES presentResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict route:StringFromByData(k_maxValue)];
        //: NSString *msg = [resultDict newStringValueForKey:@"msg"];
        NSString *msg = [resultDict route:StringFromByData(mainMakeName)];

        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict objectColor:StringFromByData(noti_rowValue)];
            //: NSString *uid = [data newStringValueForKey:@"uid"];
            NSString *uid = [data route:StringFromByData(dream_shouldTitle)];
...
-(void)background:(NSString *)userId{
    ...
    dict[StringFromByData(notiVideoData)] = [[NIMSDK sharedSDK].loginManager currentAccount];
    //: dict[@"tuid"] = userId;
    dict[StringFromByData(mainThreadAddName)] = userId;

    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/checkAddFriendEx"] params:dict isShow:NO success:^(id responseObject) {
    [TitleManager exhibitBackground:[NSString stringWithFormat:StringFromByData(dreamEndValueViewTitle)] queryedBlockOf:dict managerToObject:NO presentResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict route:StringFromByData(k_maxValue)];
        ...
        if (code.integerValue == 0) {
            ...
            //: }else{
                ...
                InsertViewController *vc = [[InsertViewController alloc] initWithImage:userId];
                //: [wself.navigationController pushViewController:vc animated:YES];
                [wself.navigationController pushViewController:vc animated:YES];
            }
...
- (MyView *)MyQRcodeView
{
    ...
    if(!_MyQRcodeView){
        ...
        _MyQRcodeView = [[MyView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
    }
...
Byte * ByDataToCache(Byte *data) {
    int tableOfNames = data[0];
    int fileThan = data[1];
    int historicalRecord = data[2];
    if (!tableOfNames) return data + historicalRecord;
    for (int i = 0; i < fileThan / 2; i++) {
        int begin = historicalRecord + i;
        int end = historicalRecord + fileThan - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[historicalRecord + fileThan] = 0;
