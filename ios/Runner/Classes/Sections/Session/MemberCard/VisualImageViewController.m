...
typedef struct {
    Byte undertakeYa;
    Byte *novella;
    unsigned int milkCrowded;
    Byte feel;
	int valueNovel;
	int biodegradablePollutionScale;
} NovelData;
...
//: canAddFriend
NovelData noti_modeValue = (NovelData){30, (Byte []){125, 127, 112, 95, 122, 122, 88, 108, 119, 123, 112, 122, 45}, 12, 165, 128, 143};

//: back_arrow_bl
NovelData app_weekTitle = (NovelData){26, (Byte []){120, 123, 121, 113, 69, 123, 104, 104, 117, 109, 69, 120, 118, 114}, 13, 224, 227, 233};

//: #F6F6F6
NovelData user_highlightName = (NovelData){192, (Byte []){227, 134, 246, 134, 246, 134, 246, 85}, 7, 209, 185, 56};

//: code
NovelData app_buttonValue = (NovelData){153, (Byte []){250, 246, 253, 252, 222}, 4, 170, 143, 80};

//: ic_group_addmember
NovelData user_mustValue = (NovelData){238, (Byte []){135, 141, 177, 137, 156, 129, 155, 158, 177, 143, 138, 138, 131, 139, 131, 140, 139, 156, 174}, 18, 245, 163, 240};

//: 邀请你加入讨论组
NovelData m_modeContent = (NovelData){209, (Byte []){56, 83, 81, 57, 126, 102, 53, 108, 113, 52, 91, 113, 52, 84, 116, 57, 127, 121, 57, 127, 107, 54, 106, 85, 1}, 24, 243, 244, 185};

//: head_default
NovelData noti_infoMaxData = (NovelData){41, (Byte []){65, 76, 72, 77, 118, 77, 76, 79, 72, 92, 69, 93, 181}, 12, 172, 183, 239};

//: group_member_info_activity_team_creator
NovelData notiButtonSessionName = (NovelData){26, (Byte []){125, 104, 117, 111, 106, 69, 119, 127, 119, 120, 127, 104, 69, 115, 116, 124, 117, 69, 123, 121, 110, 115, 108, 115, 110, 99, 69, 110, 127, 123, 119, 69, 121, 104, 127, 123, 110, 117, 104, 9}, 39, 236, 92, 43};

//: data
NovelData showChangeName = (NovelData){93, (Byte []){57, 60, 41, 60, 223}, 4, 163, 144, 109};

//: group_info_activity_team_member
NovelData m_pursuitImageData = (NovelData){136, (Byte []){239, 250, 231, 253, 248, 215, 225, 230, 238, 231, 215, 233, 235, 252, 225, 254, 225, 252, 241, 215, 252, 237, 233, 229, 215, 229, 237, 229, 234, 237, 250, 122}, 31, 227, 2, 39};

//: kNIMTeamListDataTeamMembersChanged
NovelData showFileParentValue = (NovelData){34, (Byte []){73, 108, 107, 111, 118, 71, 67, 79, 110, 75, 81, 86, 102, 67, 86, 67, 118, 71, 67, 79, 111, 71, 79, 64, 71, 80, 81, 97, 74, 67, 76, 69, 71, 70, 187}, 34, 203, 155, 98};

//: attach
NovelData mainImageAddValue = (NovelData){111, (Byte []){14, 27, 27, 14, 12, 7, 109}, 6, 252, 167, 80};

//: 邀请你加入高级群
NovelData userSeriesValue = (NovelData){199, (Byte []){46, 69, 71, 47, 104, 112, 35, 122, 103, 34, 77, 103, 34, 66, 98, 46, 108, 95, 32, 125, 96, 32, 121, 99, 98}, 24, 231, 100, 9};

//: 5D5F66
NovelData user_atValue = (NovelData){114, (Byte []){71, 54, 71, 52, 68, 68, 219}, 6, 227, 105, 42};

//: 扩展消息
NovelData mainScaleTitle = (NovelData){31, (Byte []){249, 150, 182, 250, 174, 138, 249, 169, 151, 249, 158, 176, 37}, 12, 242, 26, 68};

//: #000000
NovelData kImageQuickButtonTitle = (NovelData){189, (Byte []){158, 141, 141, 141, 141, 141, 141, 91}, 7, 173, 156, 53};

//: #05D481
NovelData userOmitName = (NovelData){244, (Byte []){215, 196, 193, 176, 192, 204, 197, 108}, 7, 205, 160, 34};

//: 邀请你加入超大群
NovelData app_textData = (NovelData){75, (Byte []){162, 201, 203, 163, 228, 252, 175, 246, 235, 174, 193, 235, 174, 206, 238, 163, 253, 206, 174, 239, 236, 172, 245, 239, 16}, 24, 191, 139, 111};

//: postscript
NovelData noti_premiumName = (NovelData){154, (Byte []){234, 245, 233, 238, 233, 249, 232, 243, 234, 238, 216}, 10, 192, 71, 173};

//: /team/getTeamSetting
NovelData app_sendLabelTitle = (NovelData){106, (Byte []){69, 30, 15, 11, 7, 69, 13, 15, 30, 62, 15, 11, 7, 57, 15, 30, 30, 3, 4, 13, 42}, 20, 198, 209, 192};

// __DEBUG__
// __CLOSE_PRINT__
//
//  VisualImageViewController.m
//  Riverla
//
...
@interface VisualImageViewController ()<UICollectionViewDelegate, UICollectionViewDataSource,NeedInfoName>
...
@implementation VisualImageViewController
...
- (void)viewDidLoad {
    ...
    [TitleManager exhibitBackground:[NSString stringWithFormat:StringFromNovelData(&app_sendLabelTitle)] queryedBlockOf:dict managerToObject:NO presentResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict route:StringFromNovelData(&app_buttonValue)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict objectColor:StringFromNovelData(&showChangeName)];
    ...
    NSString *kNIMTeamListDataTeamMembersChanged = StringFromNovelData(&showFileParentValue);
...
- (void)skinny {
    ...
    [backButton setImage:[UIImage imageNamed:StringFromNovelData(&app_weekTitle)] forState:(UIControlStateNormal)];
    ...
    submitButton.backgroundColor = [UIColor ground:StringFromNovelData(&userOmitName)];
    //: submitButton.layer.cornerRadius = 16;
    submitButton.layer.cornerRadius = 16;
    //: [submitButton setImage:[UIImage imageNamed:@"ic_group_addmember"] forState:(UIControlStateNormal)];
    [submitButton setImage:[UIImage imageNamed:StringFromNovelData(&user_mustValue)] forState:(UIControlStateNormal)];
    ...
    UIView *owerView = [[UIView alloc]initWithFrame:CGRectMake(15, (44.0f + [UIDevice heightShowStop])+9, [[UIScreen mainScreen] bounds].size.width-30, 72)];
    //: owerView.backgroundColor = [UIColor colorWithHexString:@"#F6F6F6"];
    owerView.backgroundColor = [UIColor ground:StringFromNovelData(&user_highlightName)];
    ...
    _titleLabel.textColor = [UIColor ground:StringFromNovelData(&kImageQuickButtonTitle)];
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(15, (44.0f + [UIDevice heightShowStop])+90, [[UIScreen mainScreen] bounds].size.width-30, [[UIScreen mainScreen] bounds].size.height-(44.0f + [UIDevice heightShowStop])-90) collectionViewLayout:layout];
    ...
    [self.collectionView registerClass:[SameViewCell class] forCellWithReuseIdentifier:@"SameViewCell"];
...
- (void)anointExamine:(NSArray *)selectedContacts{
    ...
    [self cell:selectedContacts beyondLanguage:nil];
}

//: - (void)didInviteUsers:(NSArray<NSString *> *)userIds
- (void)cell:(NSArray<NSString *> *)userIds
            //: completion:(dispatch_block_t)completion {
            beyondLanguage:(dispatch_block_t)completion {
    ...
    NSMutableDictionary *info = [NSMutableDictionary dictionary];
    //: info[@"attach"] = @"扩展消息";
    info[StringFromNovelData(&mainImageAddValue)] = StringFromNovelData(&mainScaleTitle);
    //: switch (self.teamListManager.team.type) {
    switch (self.teamListManager.team.type) {
        //: case NIMTeamTypeNormal:
        case NIMTeamTypeNormal:
            //: info[@"postscript"] = @"邀请你加入讨论组".nim_localized;
            info[StringFromNovelData(&noti_premiumName)] = StringFromNovelData(&m_modeContent).titleBy;
            //: break;
            break;
        //: case NIMTeamTypeAdvanced:
        case NIMTeamTypeAdvanced:
            //: info[@"postscript"] = @"邀请你加入高级群".nim_localized;
            info[StringFromNovelData(&noti_premiumName)] = StringFromNovelData(&userSeriesValue).titleBy;
            //: break;
            break;
        //: case NIMTeamTypeSuper:
        case NIMTeamTypeSuper:
            //: info[@"postscript"] = @"邀请你加入超大群".nim_localized;
            info[StringFromNovelData(&noti_premiumName)] = StringFromNovelData(&app_textData).titleBy;
            //: break;
            break;
        //: default:
        default:
        ...
        if (!error) {
            ...
            for (NIMTeamMember *member in members) {
                ...
                //: }else if (member.type == NIMTeamMemberTypeOwner){
                    ...
                    [self.roleImageView sd_setImageWithURL:[NSURL URLWithString:info.avatarUrlString] placeholderImage:[UIImage imageNamed:StringFromNovelData(&noti_infoMaxData)]];
                }
            }
            //: [self.collectionView reloadData];
            [self.collectionView reloadData];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *canMemberInfo = [_teamSettingConfig route:StringFromNovelData(&noti_modeValue)];
...
//        [self.navigationController pushViewController:vc animated:YES];
        ...
        SystemViewController *vc = [[SystemViewController alloc] initWithAdd:member.userId];
        //: [self.navigationController pushViewController:vc animated:YES];
        [self.navigationController pushViewController:vc animated:YES];
    }
}
...
Byte *NovelDataToByte(NovelData *data) {
    if (data->feel < 147) return data->novella;
    for (int i = 0; i < data->milkCrowded; i++) {
        data->novella[i] ^= data->undertakeYa;
    }
    data->novella[data->milkCrowded] = 0;
    data->feel = 28;
	if (data->milkCrowded >= 2) {
		data->valueNovel = data->novella[0];
		data->biodegradablePollutionScale = data->novella[1];
	}
    return data->novella;
}
