...
NSString *StringFromMustData(Byte *data);


//: /user/detail
Byte userSuccessData[] = {86, 12, 11, 3, 15, 88, 169, 213, 76, 213, 146, 108, 105, 97, 116, 101, 100, 47, 114, 101, 115, 117, 47, 69};

//: modify_activity_modify_success
Byte notiDisableName[] = {11, 30, 7, 56, 235, 158, 193, 115, 115, 101, 99, 99, 117, 115, 95, 121, 102, 105, 100, 111, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 121, 102, 105, 100, 111, 109, 241};

//: ic_card_edit
Byte mUndertakeData[] = {68, 12, 10, 146, 103, 140, 23, 42, 158, 176, 116, 105, 100, 101, 95, 100, 114, 97, 99, 95, 99, 105, 233};

//: activity_group_member_info2_shenfen
Byte k_weekContent[] = {56, 35, 8, 33, 59, 11, 177, 141, 110, 101, 102, 110, 101, 104, 115, 95, 50, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 151};

//: group_info_activity_op_failed
Byte kHandleFortunateName[] = {18, 29, 8, 156, 241, 199, 220, 44, 100, 101, 108, 105, 97, 102, 95, 112, 111, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 112, 117, 111, 114, 103, 59};

//: head_default
Byte mFortunateValue[] = {24, 12, 5, 136, 76, 116, 108, 117, 97, 102, 101, 100, 95, 100, 97, 101, 104, 172};

//: icon_me_arrow
Byte show_atData[] = {28, 13, 6, 115, 57, 35, 119, 111, 114, 114, 97, 95, 101, 109, 95, 110, 111, 99, 105, 136};

//: ic_invite
Byte noti_buttonGivingData[] = {40, 9, 8, 99, 103, 199, 91, 235, 101, 116, 105, 118, 110, 105, 95, 99, 105, 160};

//: ic_sex_woman
Byte appFortunateText[] = {71, 12, 3, 110, 97, 109, 111, 119, 95, 120, 101, 115, 95, 99, 105, 207};

//: group_member_info_activity_mute_msg
Byte user_scaleContent[] = {25, 35, 3, 103, 115, 109, 95, 101, 116, 117, 109, 95, 121, 116, 105, 118, 105, 116, 99, 97, 95, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 113};

//: #ECECEC
Byte m_uniteValue[] = {67, 7, 12, 172, 161, 162, 178, 117, 43, 62, 121, 97, 67, 69, 67, 69, 67, 69, 35, 27};

//: ic_sex_man
Byte k_buttonImageText[] = {91, 10, 6, 231, 245, 47, 110, 97, 109, 95, 120, 101, 115, 95, 99, 105, 132};

//: #EEEEEE
Byte m_hidePressValue[] = {11, 7, 13, 85, 43, 205, 106, 149, 60, 182, 213, 34, 123, 69, 69, 69, 69, 69, 69, 35, 44};

//: activity_group_member_info2_inviter
Byte app_drugText[] = {32, 35, 6, 243, 167, 192, 114, 101, 116, 105, 118, 110, 105, 95, 50, 111, 102, 110, 105, 95, 114, 101, 98, 109, 101, 109, 95, 112, 117, 111, 114, 103, 95, 121, 116, 105, 118, 105, 116, 99, 97, 156};

//: ic_group_lists
Byte app_successContent[] = {59, 14, 7, 241, 186, 239, 74, 115, 116, 115, 105, 108, 95, 112, 117, 111, 114, 103, 95, 99, 105, 95};

//: #FF483D
Byte mColorContent[] = {11, 7, 6, 163, 168, 187, 68, 51, 56, 52, 70, 70, 35, 154};

//: personcart_profile_bg
Byte noti_sessionImageValue[] = {5, 21, 10, 78, 136, 162, 177, 193, 217, 203, 103, 98, 95, 101, 108, 105, 102, 111, 114, 112, 95, 116, 114, 97, 99, 110, 111, 115, 114, 101, 112, 251};

//: #2C3042
Byte kByWeekData[] = {51, 7, 5, 140, 149, 50, 52, 48, 51, 67, 50, 35, 199};

//: personCard_bg
Byte mainAgainstCrowdedViewValue[] = {65, 13, 8, 127, 172, 206, 17, 177, 103, 98, 95, 100, 114, 97, 67, 110, 111, 115, 114, 101, 112, 19};
...
//: #F6F7FA
Byte k_nameValue[] = {32, 7, 4, 111, 65, 70, 55, 70, 54, 70, 35, 94};

//: back_arrow_bl
Byte app_handleTitle[] = {71, 13, 12, 14, 172, 174, 96, 207, 155, 243, 166, 115, 108, 98, 95, 119, 111, 114, 114, 97, 95, 107, 99, 97, 98, 156};

//: ic_identity_authentication
Byte dream_accelerateName[] = {11, 26, 4, 14, 110, 111, 105, 116, 97, 99, 105, 116, 110, 101, 104, 116, 117, 97, 95, 121, 116, 105, 116, 110, 101, 100, 105, 95, 99, 105, 137};

//: #05D481
Byte kIllegalData[] = {17, 7, 6, 77, 70, 166, 49, 56, 52, 68, 53, 48, 35, 196};

//: data
Byte show_youthTitle[] = {94, 4, 12, 122, 40, 241, 214, 55, 199, 172, 90, 104, 97, 116, 97, 100, 244};

//: user_id
Byte userOmitText[] = {37, 7, 7, 74, 132, 27, 24, 100, 105, 95, 114, 101, 115, 117, 69};

//: account
Byte m_barrelValue[] = {15, 7, 4, 135, 116, 110, 117, 111, 99, 99, 97, 159};

//: 移出本群
Byte main_messageData[] = {97, 12, 9, 23, 192, 119, 79, 170, 128, 164, 190, 231, 172, 156, 230, 186, 135, 229, 187, 167, 231, 250};

//: 本地不存在
Byte k_showChangeContent[] = {33, 15, 10, 81, 140, 43, 254, 131, 248, 22, 168, 156, 229, 152, 173, 229, 141, 184, 228, 176, 156, 229, 172, 156, 230, 39};

//: #8A8E98
Byte user_messageName[] = {69, 7, 7, 144, 55, 229, 162, 56, 57, 69, 56, 65, 56, 35, 208};

//: code
Byte dreamAddName[] = {6, 4, 5, 226, 32, 101, 100, 111, 99, 217};
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor ground:StringFromMustData(k_nameValue)];
...
//    [self refresh];
    ...
    dict[StringFromMustData(userOmitText)] = self.memberId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/user/detail"] params:dict isShow:NO success:^(id responseObject) {
    [TitleManager exhibitBackground:[NSString stringWithFormat:StringFromMustData(userSuccessData)] queryedBlockOf:dict managerToObject:NO presentResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict route:StringFromMustData(dreamAddName)];
        //: if (code.integerValue <= 0) {
        if (code.integerValue <= 0) {
            //: NSDictionary *data = [resultDict valueObjectForKey:@"data"];
            NSDictionary *data = [resultDict objectColor:StringFromMustData(show_youthTitle)];
            //: self.userAcount = [data newStringValueForKey:@"account"];
            self.userAcount = [data route:StringFromMustData(m_barrelValue)];
...
- (UIView *)userView
{
    ...
    if(!_userView){
        ...
        Bg.image = [UIImage imageNamed:StringFromMustData(mainAgainstCrowdedViewValue)];
        ...
        UIImageView *userBg = [[UIImageView alloc]initWithFrame:CGRectMake(([[UIScreen mainScreen] bounds].size.width-345)/2, [UIDevice heightShowStop]+44+20, 345, 140)];
        //: userBg.image = [UIImage imageNamed:@"personcart_profile_bg"];
        userBg.image = [UIImage imageNamed:StringFromMustData(noti_sessionImageValue)];
        ...
        [self.accountheadImg sd_setImageWithURL:[NSURL URLWithString:self.user.userInfo.avatarUrl] placeholderImage:[UIImage imageNamed:StringFromMustData(mFortunateValue)]];
        ...
        if (self.user.userInfo.gender == NIMUserGenderMale) {
            ...
            sexImg.image = [UIImage imageNamed:StringFromMustData(k_buttonImageText)];
        //: }else if (self.user.userInfo.gender == NIMUserGenderFemale){
        }else if (self.user.userInfo.gender == NIMUserGenderFemale){
            //: sexImg.image = [UIImage imageNamed:@"ic_sex_woman"];
            sexImg.image = [UIImage imageNamed:StringFromMustData(appFortunateText)];
        }
...
//        self.accountId.backgroundColor = RGB_COLOR_String(@"#FDF4C9");
        ...
        self.accountId.textColor = [UIColor ground:StringFromMustData(kByWeekData)];
        ...
        [self.closeBtn setImage:[UIImage imageNamed:StringFromMustData(app_handleTitle)] forState:(UIControlStateNormal)];
...
- (UIView *)personView
{
    ...
    if(!_personView){
        ...
        UITapGestureRecognizer *panGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(extraIndex)];
        ...
        pic1.image = [UIImage imageNamed:StringFromMustData(mUndertakeData)];
        ...
        self.labRemark.textColor = [UIColor ground:StringFromMustData(user_messageName)];
        ...
        arrow.image = [UIImage imageNamed:StringFromMustData(show_atData)];
        ...
        line1.backgroundColor = [UIColor ground:StringFromMustData(m_uniteValue)];
        ...
        icon2.image = [UIImage imageNamed:StringFromMustData(dream_accelerateName)];
        ...
        arrow2.image = [UIImage imageNamed:StringFromMustData(show_atData)];
        ...
        line2.backgroundColor = [UIColor ground:StringFromMustData(m_uniteValue)];
        ...
        icon3.image = [UIImage imageNamed:StringFromMustData(noti_buttonGivingData)];
        ...
        sublab3.textColor = [UIColor ground:StringFromMustData(kIllegalData)];
        //: sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : @"本地不存在".nim_localized;
        sublab3.text = _member.inviterAccid ? (_member.inviterAccid.length ? _member.inviterAccid : _member.userId) : StringFromMustData(k_showChangeContent).titleBy;
        ...
        arrow3.image = [UIImage imageNamed:StringFromMustData(show_atData)];
        ...
        line3.backgroundColor = [UIColor ground:StringFromMustData(m_uniteValue)];
        ...
        icon4.image = [UIImage imageNamed:StringFromMustData(app_successContent)];
        ...
        [pushSwitch setOnTintColor: [UIColor ground:StringFromMustData(kIllegalData)]];
        //: [pushSwitch addTarget:self action:@selector(updateMute:) forControlEvents:UIControlEventValueChanged];
        [pushSwitch addTarget:self action:@selector(labs:) forControlEvents:UIControlEventValueChanged];
        ...
        if(canEdit){
            ...
            [self.btnDelete setTitleColor:[UIColor ground:StringFromMustData(mColorContent)] forState:UIControlStateNormal];
            ...
            self.btnDelete.layer.borderColor = [UIColor ground:StringFromMustData(m_hidePressValue)].CGColor;
...
Byte * MustDataToCache(Byte *data) {
    int handleSuccess = data[0];
    int givingDrinking = data[1];
    int cousinInfoPlanet = data[2];
    if (!handleSuccess) return data + cousinInfoPlanet;
    for (int i = 0; i < givingDrinking / 2; i++) {
        int begin = cousinInfoPlanet + i;
        int end = cousinInfoPlanet + givingDrinking - i - 1;
        Byte temp = data[begin];
        data[begin] = data[end];
        data[end] = temp;
    }
    data[0] = 0;
    data[cousinInfoPlanet + givingDrinking] = 0;
    return data + cousinInfoPlanet;
}

NSString *StringFromMustData(Byte *data) {
    return [NSString stringWithUTF8String:(char *)MustDataToCache(data)];
}  
