...
@implementation UIImage (SystemTeam)

//缩放到指定大小
//: - (UIImage*)imageCompressWithSimple:(UIImage*)image scaledToSize:(CGSize)size
- (UIImage*)container:(UIImage*)image origin:(CGSize)size
{
...
+ (UIImage *)team:(UIColor *)color click:(CGFloat)radius
{
