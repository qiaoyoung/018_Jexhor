...
@interface ViewColor : NSObject<NIMCustomAttachment,GermanismInfo>
...
@property (nonatomic,strong) NSMutableArray <TeamAbstract *> *abstracts;
...
@interface TeamAbstract : NSObject
