...
- (void)image:(RedView *)cycleScrollView timeSuccess:(NSInteger)index;

/** 图片滚动回调 */
//: - (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index;
- (void)part:(RedView *)cycleScrollView list:(NSInteger)index;
...
+ (instancetype)tag:(CGRect)frame location:(NSArray *)imageURLStringsGroup;
...
@property (nonatomic, weak) id<OffDelegate> delegate;
