...
+ (NSString *)data:(NSString *)filepath
{
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:filepath])
    {
        ...
        unsigned long long fileSize = [self title:filepath];
        //: if(fileSize > 200 * 1024 * 1024) {
        if(fileSize > 200 * 1024 * 1024) {
            //: md5 = [self bigFileMD5:filepath];
            md5 = [self holderMd5:filepath];
        //: }else {
        }else {
            //: NSData *data = [NSData dataWithContentsOfFile:filepath];
            NSData *data = [NSData dataWithContentsOfFile:filepath];
            //: md5 = [data MD5String];
            md5 = [data independent];
        }
    }
    //: return md5;
    return md5;
...
+ (void)completion:(NSString *)filepath keyTo:(void(^)(NSString *MD5))completion;
{
...
+ (NSString *)holderMd5:(NSString *)filePath
{
...
+ (unsigned long long)title:(NSString *)filepath
{
