...
@interface NameSquareMeasureUnit : NSObject<NSCoding>
...
@interface AncientHistoryCircle : NSObject
{
...
- (NameSquareMeasureUnit *)pageView: (NSString *)source; //全拼，简拼 (全是小写)
//: - (NSString *)firstLetter: (NSString *)input; 
- (NSString *)destabilisation: (NSString *)input; //首字母
//: @end
@end