...
#import "UIDevice+ImageAddition.h"

//: @implementation UIDevice (VGAddition)
@implementation UIDevice (ImageAddition)
...
+ (CGFloat)heightShowStop {
    ...
    if (statusBarHeight <= 0) {
        ...
        CGFloat topPadding = [UIDevice managerBy];
...
+ (CGFloat)biologyLab {
    ...
    return [UIDevice heightShowStop] + [UIDevice ting];
}
